...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7830],
  {
    64861: function (t, e, r) {
      ...
      function T(t) {
        return h.Buffer.from(t, "base64");
      }
      function L(t) {
        return t instanceof p.PublicKey ? t : new p.PublicKey(t);
      }
      ...
      function* R(t, e, r) {
        ...
        if (
          o &&
          ((t = e.coercer(t, a)),
          s && "type" !== e.type && D(e.schema) && D(t) && !Array.isArray(t))
        )
      ...
      class N {
        constructor(t) {
          ...
          (this.type = e),
            ...
            (this.coercer = o),
            n
              ? (this.validator = (t, e) => B(n(t, e), e, this, t))
              : (this.validator = () => []),
            i
              ? (this.refiner = (t, e) => B(i(t, e), e, this, t))
              : (this.refiner = () => []);
        }
        assert(t) {
          return (function (t, e) {
      ...
      function j(t) {
        ...
        return new N({
          ...
          validator: (r) =>
            r === t ||
            "Expected the literal `" + e + "`, but received: " + O(r),
        });
      }
      function q(t) {
        return new N({
      ...
      function W(t) {
        ...
        return new N({
          ...
          schema: t,
          *entries(r) {
            if (D(r)) for (let n of e) yield [n, r[n], t[n]];
          },
          validator: (t) => D(t) || "Expected an object, but received: " + O(t),
        });
      }
      function H(t) {
      ...
      async function J(t, e, r) {
        if (e.length <= 99) return await Z(t, e, r);
        {
          let n = Array.apply(0, Array(Math.ceil(e.length / 99))).map((t, r) =>
            e.slice(99 * r, (r + 1) * 99)
          );
          return (await Promise.all(n.map((e) => Z(t, e, r)))).flat();
        }
      }
      ...
      async function Y(t, e, r, n, i) {
        ...
        r && (u.sigVerify = !0);
        let l = U(await t._rpcRequest("simulateTransaction", [c, u]), tt);
        if ("error" in l) {
          let t;
          if (
            "data" in l.error &&
          ...
          throw new p.SendTransactionError(
      ...
      function Q(t) {
        return H([
          W({ jsonrpc: j("2.0"), id: F(), result: t }),
          W({
            jsonrpc: j("2.0"),
            id: F(),
            error: W({ code: G(), message: F(), data: z(V("any", () => !0)) }),
          }),
        ]);
      }
      let tt =
          ...
          accounts: z(
            q(
              $(
                q(
                  W({
                    executable: V("boolean", (t) => "boolean" == typeof t),
                    owner: F(),
                    lamports: K(),
                    data: $(F()),
                    rentEpoch: z(K()),
        ...
        (o = Q((i = W({ context: W({ slot: K() }), value: n })))),
        (s = (t) => ("error" in t ? t : { ...t, result: U(t.result, i) })),
        new N({
          ...o,
          coercer: (t, e) =>
            M(t, X)[0] ? o.coercer(t, e) : o.coercer(s(t, e), e),
        }));
      class te {
        constructor(t, e, r) {
          (this.connection = t),
        ...
        async sendAndConfirm(t, e, r) {
          var n, i, o, s;
          if ((void 0 === r && (r = this.opts), S(t))) e && t.sign(e);
          else if (
            ((t.feePayer =
          ...
          try {
            return await tn(this.connection, a, r);
          } catch (e) {
            if (e instanceof ti) {
              let r = P(
                  S(t)
                ...
                n = await this.connection.getTransaction(r, {
              ...
              if (n) {
                let t =
                  null === (s = n.meta) || void 0 === s
                    ? void 0
                    : s.logMessages;
                throw t ? new p.SendTransactionError(e.message, t) : e;
              }
            }
            throw e;
          }
        ...
        async sendAll(t, e) {
          ...
          for (let t = 0; t < s.length; t += 1) {
            let o = a[t],
              s = o.serialize();
            try {
              c.push(await tn(this.connection, s, e));
            } catch (t) {
              if (t instanceof ti) {
                let e = P(
                    S(o)
                ...
                if (s) {
                  let e =
                    null === (i = s.meta) || void 0 === i
                      ? void 0
                      : i.logMessages;
                  throw e ? new p.SendTransactionError(t.message, e) : t;
                }
              }
              throw t;
            }
        ...
        async simulate(t, e, r, n) {
          ...
          if (
            (S(t)
              ? (e && (t.sign(e), (t = await this.wallet.signTransaction(t))),
                (i = await this.connection.simulateTransaction(t, {
                  commitment: r,
                })))
              : ((t.feePayer = t.feePayer || this.wallet.publicKey),
                (t.recentBlockhash = o),
                e && (t = await this.wallet.signTransaction(t)),
                (i = await Y(this.connection, t, e, r, n))),
            i.value.err)
          )
            throw new tr(i.value);
          return i.value;
        }
      }
      ...
      async function tn(t, e, r) {
        ...
        if (o.err)
          throw new ti(`Raw transaction ${i} failed (${JSON.stringify(o)})`);
        return i;
      }
      ...
      function to() {
        return null === ts ? te.local() : ts;
      }
      let ts = null,
        ta = new Map();
      function tc(t) {
        return void 0 !== ta.get(t);
      }
      ...
      class td extends Error {
        constructor(t, e, r, n, i, o) {
          super(r.join("\n").replace("Program log: ", "")),
            ...
            (this._programErrorStack = tl.parse(n));
        }
        static parse(t) {
          let e;
          if (!t) return null;
          ...
          if (r + 1 < t.length) {
            if ("Program log: Left:" === t[r + 1]) {
              let n = /^Program log: (.*)$/,
                o = n.exec(t[r + 2])[1],
                s = n.exec(t[r + 4])[1];
              (e = [new p.PublicKey(o), new p.PublicKey(s)]),
          ...
          if (o) {
            ...
            return new td({ code: r, number: parseInt(n) }, s, i, t, void 0, e);
          }
          if (s) {
          ...
          if (!a) return null;
          {
            ...
            return new td({ code: n, number: parseInt(o) }, s, i, t, r, e);
          }
        }
        get program() {
      ...
      class th extends Error {
        constructor(t, e, r) {
          super(),
            ...
            (this.msg = e),
            (this.logs = r),
            r && (this._programErrorStack = tl.parse(r));
        }
        static parse(t, e) {
          let r, n;
          let i = t.toString();
          ...
          let o = e.get(n);
          return void 0 !== o || void 0 !== (o = ty.get(n))
            ? new th(n, o, t.logs)
            : null;
        }
        get program() {
      ...
      function tp(t, e) {
        tc("debug-logs") && console.log("Translating error:", t);
        let r = td.parse(t.logs);
        return r
          ? r
          : th.parse(t, e) ||
              (t.logs
                ? ((t.programErrorStack = tl.parse(t.logs)),
                  new Proxy(t, {
                    get: function (e, r) {
      ...
      let tf = {
        ...
        ty = new Map([
          [tf.InstructionMissing, "8 byte instruction identifier not provided"],
          [
            tf.InstructionFallbackNotFound,
            "Fallback functions are not supported",
          ],
          [
            tf.InstructionDidNotDeserialize,
            "The program could not deserialize the given instruction",
          ],
          [
            tf.InstructionDidNotSerialize,
            "The program could not serialize the given instruction",
          ],
          [
            tf.IdlInstructionStub,
            "The program was compiled without idl instructions",
          ],
          [
            tf.IdlInstructionInvalidProgram,
            "The transaction was given an invalid program for the IDL instruction",
          ],
          [tf.ConstraintMut, "A mut constraint was violated"],
          [tf.ConstraintHasOne, "A has one constraint was violated"],
          [tf.ConstraintSigner, "A signer constraint was violated"],
          [tf.ConstraintRaw, "A raw constraint was violated"],
          [tf.ConstraintOwner, "An owner constraint was violated"],
          [tf.ConstraintRentExempt, "A rent exemption constraint was violated"],
          [tf.ConstraintSeeds, "A seeds constraint was violated"],
          [tf.ConstraintExecutable, "An executable constraint was violated"],
          [
            tf.ConstraintState,
            "Deprecated Error, feel free to replace with something else",
          ],
          [tf.ConstraintAssociated, "An associated constraint was violated"],
          [
            tf.ConstraintAssociatedInit,
            "An associated init constraint was violated",
          ],
          [tf.ConstraintClose, "A close constraint was violated"],
          [tf.ConstraintAddress, "An address constraint was violated"],
          [tf.ConstraintZero, "Expected zero account discriminant"],
          [tf.ConstraintTokenMint, "A token mint constraint was violated"],
          [tf.ConstraintTokenOwner, "A token owner constraint was violated"],
          [
            tf.ConstraintMintMintAuthority,
            "A mint mint authority constraint was violated",
          ],
          [
            tf.ConstraintMintFreezeAuthority,
            "A mint freeze authority constraint was violated",
          ],
          [
            tf.ConstraintMintDecimals,
            "A mint decimals constraint was violated",
          ],
          [tf.ConstraintSpace, "A space constraint was violated"],
          [
            tf.ConstraintAccountIsNone,
            "A required account for the constraint is None",
          ],
          [tf.RequireViolated, "A require expression was violated"],
          [tf.RequireEqViolated, "A require_eq expression was violated"],
          [
            tf.RequireKeysEqViolated,
            "A require_keys_eq expression was violated",
          ],
          [tf.RequireNeqViolated, "A require_neq expression was violated"],
          [
            tf.RequireKeysNeqViolated,
            "A require_keys_neq expression was violated",
          ],
          [tf.RequireGtViolated, "A require_gt expression was violated"],
          [tf.RequireGteViolated, "A require_gte expression was violated"],
          [
            tf.AccountDiscriminatorAlreadySet,
            "The account discriminator was already set on this account",
          ],
          [
            tf.AccountDiscriminatorNotFound,
            "No 8 byte discriminator was found on the account",
          ],
          [
            tf.AccountDiscriminatorMismatch,
            "8 byte discriminator did not match what was expected",
          ],
          [tf.AccountDidNotDeserialize, "Failed to deserialize the account"],
          [tf.AccountDidNotSerialize, "Failed to serialize the account"],
          [
            tf.AccountNotEnoughKeys,
            "Not enough account keys given to the instruction",
          ],
          [tf.AccountNotMutable, "The given account is not mutable"],
          [
            tf.AccountOwnedByWrongProgram,
            "The given account is owned by a different program than expected",
          ],
          [tf.InvalidProgramId, "Program ID was not as expected"],
          [tf.InvalidProgramExecutable, "Program account is not executable"],
          [tf.AccountNotSigner, "The given account did not sign"],
          [
            tf.AccountNotSystemOwned,
            "The given account is not owned by the system program",
          ],
          [
            tf.AccountNotInitialized,
            "The program expected this account to be already initialized",
          ],
          [
            tf.AccountNotProgramData,
            "The given account is not a program data account",
          ],
          [
            tf.AccountNotAssociatedTokenAccount,
            "The given account is not the associated token account",
          ],
          [
            tf.AccountSysvarMismatch,
            "The given public key does not match the required sysvar",
          ],
          [
            tf.AccountReallocExceedsLimit,
            "The account reallocation exceeds the MAX_PERMITTED_DATA_INCREASE limit",
          ],
          [
            tf.AccountDuplicateReallocs,
      ...
      class tA {
        static fieldLayout(t, e) {
          let r = void 0 !== t.name ? w()(t.name) : void 0;
          switch (t.type) {
            case "bool":
              return b.bool(r);
            case "u8":
            ...
            case "string":
              return b.str(r);
            case "publicKey":
              return b.publicKey(r);
            default:
              if ("vec" in t.type)
                return b.vec(
                  tA.fieldLayout({ name: void 0, type: t.type.vec }, e),
                  r
                );
              if ("option" in t.type)
                return b.option(
                  tA.fieldLayout({ name: void 0, type: t.type.option }, e),
                  r
                );
              if ("defined" in t.type) {
                if (!e) throw new tu("User defined types not provided");
                let n = t.type.defined,
                  i = e.filter((t) => t.name === n);
                if (1 !== i.length)
                  throw new tu(`Type not found: ${JSON.stringify(t)}`);
                return tA.typeDefLayout(i[0], e, r);
              }
              if ("array" in t.type) {
                let n = t.type.array[0],
                  i = t.type.array[1],
                  o = tA.fieldLayout({ name: void 0, type: n }, e);
                return b.array(o, i, r);
        ...
        static typeDefLayout(t, e = [], r) {
          switch (t.type.kind) {
            case "struct": {
              let n = t.type.fields.map((t) => tA.fieldLayout(t, e));
              return b.struct(n, r);
            }
            case "enum": {
              let n = t.type.variants.map((t) => {
                let r = w()(t.name);
                if (!t.fields) return b.struct([], r);
                let n = t.fields.map((t, r) =>
                  (null == t ? void 0 : t.name)
                    ? tA.fieldLayout(t, e)
                    : tA.fieldLayout({ type: t, name: r.toString() }, e)
                );
                return b.struct(n, r);
              });
              if (void 0 !== r) return b.rustEnum(n).replicate(r);
              return b.rustEnum(n, r);
            }
            case "alias":
              return tA.fieldLayout({ type: t.type.value, name: t.name }, e);
          }
        }
      }
      let tE = "global";
      class tI {
        constructor(t) {
          (this.idl = t), (this.ixLayout = tI.parseIxLayout(t));
          let e = new Map();
        ...
        static parseIxLayout(t) {
          let e = t.instructions.map((e) => {
            let r = e.args.map((e) => {
              ...
              n = w()(e.name);
            return [n, b.struct(r, n)];
          });
          return new Map(e);
        }
        decode(t, e = "hex") {
          "string" == typeof t &&
            (t = "hex" === e ? h.Buffer.from(t, "hex") : g().decode(t));
          let r = g().encode(t.slice(0, 8)),
            n = t.slice(8),
            i = this.sighashLayouts.get(r);
          return i ? { data: i.layout.decode(n), name: i.name } : null;
        }
        format(t, e) {
          return tx.format(t, e, this.idl);
        }
      }
      class tx {
        static format(t, e, r) {
          ...
          let i = n.args.map((e) => ({
              name: e.name,
              type: tx.formatIdlType(e.type),
              data: tx.formatIdlData(e, t.data[e.name], r.types),
            })),
            o = tx.flattenIdlAccounts(n.accounts);
          return {
            args: i,
            accounts: e.map((t, e) =>
        ...
        static formatIdlData(t, e, r) {
          ...
          if (t.type.hasOwnProperty("vec"))
            return (
              ...
              e
                .map((e) =>
                  this.formatIdlData({ name: "", type: t.type.vec }, e)
                )
                .join(", ") +
              "]"
            );
          ...
          if (t.type.hasOwnProperty("defined")) {
            ...
            if (1 !== n.length)
              throw Error(`Type not found: ${t.type.defined}`);
            return tx.formatIdlDataDefined(n[0], e, r);
          }
          return "unknown";
        }
          ...
          switch (t.type.kind) {
            case "struct": {
              ...
              return (
                ...
                Object.keys(e)
                  .map((t) => {
                    let i = n.fields.find((e) => e.name === t);
                    if (!i) throw Error("Unable to find type");
                    return t + ": " + tx.formatIdlData(i, e[t], r);
                  })
                  .join(", ") +
                " }"
              );
                      ...
                      let s = o[t],
                        a =
                          null === (e = n[i]) || void 0 === e
                            ? void 0
                            : e.find((e) => e.name === t);
                      if (!a) throw Error("Unable to find variant");
                      return t + ": " + tx.formatIdlData(a, s, r);
                    })
                    .join(", "),
                  a = w()(i, { pascalCase: !0 });
            ...
            case "alias":
              return tx.formatIdlType(t.type.value);
          }
        }
        static flattenIdlAccounts(t, e) {
          return t
            .map((t) => {
              ...
              {
                let n = e ? `${e} > ${r}` : r;
                return tx.flattenIdlAccounts(t.accounts, n);
              }
            })
            .flat();
        }
      ...
      function tS(t, e) {
        ...
        let i =
          ...
          o = `${t}:${i}`;
        return h.Buffer.from((0, _.J)(o).slice(0, 8));
      }
      function tP(t, e) {
        switch (e.type.kind) {
          case "struct":
            return e.type.fields
              .map((e) => tk(t, e.type))
              .reduce((t, e) => t + e, 0);
          case "enum":
            return (
              Math.max(
                ...e.type.variants.map((e) =>
                  e.fields
                    ? e.fields
                        .map((e) =>
      ...
      function tk(t, e) {
        ...
        switch (e) {
          ...
          default:
            ...
            if ("option" in e) return 1 + tk(t, e.option);
            if ("coption" in e) return 4 + tk(t, e.coption);
            if ("defined" in e) {
              let i =
                null !==
                  (n =
                  ...
                  : [];
              if (1 !== i.length)
                throw new tu(`Type not found: ${JSON.stringify(e)}`);
              return tP(t, i[0]);
            }
            if ("array" in e) {
              let r = e.array[0],
      ...
      function tT(t) {
        return x.from((0, _.J)(t).slice(0, 8));
      }
      class tL {
        constructor(t) {
          ...
          let e = t.accounts.map((e) => [e.name, tA.typeDefLayout(e, t.types)]);
        ...
        async encode(t, e) {
          ...
          let i = n.encode(e, r),
            o = r.slice(0, i),
            s = tL.accountDiscriminator(t);
          return h.Buffer.concat([s, o]);
        }
        decode(t, e) {
          if (tL.accountDiscriminator(t).compare(e.slice(0, 8)))
        ...
        decodeAny(t) {
          let e = t.slice(0, 8),
            r = Array.from(this.accountLayouts.keys()).find((t) =>
              tL.accountDiscriminator(t).equals(e)
            );
        ...
        memcmp(t, e) {
          let r = tL.accountDiscriminator(t);
          return {
            offset: 0,
        ...
        size(t) {
          var e;
          return 8 + (null !== (e = tP(this.idl, t)) && void 0 !== e ? e : 0);
        }
      ...
      class tC {
        constructor(t) {
          ...
          let e = t.events.map((e) => {
            ...
            return [e.name, tA.typeDefLayout(r, t.types)];
          });
          (this.layouts = new Map(e)),
            (this.discriminators = new Map(
              void 0 === t.events
                ...
                : t.events.map((t) => {
                    var e;
                    return [k(((e = t.name), tT(`event:${e}`))), t.name];
                  })
            ));
        }
        decode(t) {
      ...
      class tD {
        constructor(t) {
          ...
          let e = t.types.map((e) => [e.name, tA.typeDefLayout(e, t.types)]);
      ...
      class tO {
        constructor(t) {
          (this.instruction = new tI(t)),
            (this.accounts = new tL(t)),
            (this.events = new tC(t)),
            (this.types = new tD(t));
        }
      }
      var tB =
      ...
      class tM extends tU {
        constructor(t, e, r) {
          if (!(t instanceof tR)) throw TypeError("layout must be a Layout");
          if (void 0 === e) e = 0;
        ...
        isCount() {
          return this.layout instanceof tV || this.layout instanceof t$;
        }
        decode(t, e) {
          return (
      ...
      class tF extends tR {
        constructor(t, e, r) {
          if (
            !(Array.isArray(t) && t.reduce((t, e) => t && e instanceof tR, !0))
          )
      ...
      class tG extends tR {
        constructor(t, e, r) {
          let n = t instanceof tV || t instanceof t$;
          if (n) t = new tH(new tM(t));
          else if (t instanceof tU && t.isCount()) t = new tH(t);
          else if (!(t instanceof tW))
            throw TypeError(
              "discr must be a UnionDiscriminator or an unsigned integer layout"
            );
          if ((void 0 === e && (e = null), !(null === e || e instanceof tR)))
      ...
      class tZ extends tR {
        constructor(t, e) {
          ...
          let r = -1;
          t instanceof tU || (r = t), super(r, e), (this.length = t);
        }
        getSpan(t, e) {
          let r = this.span;
        ...
        encode(t, e, r) {
          let n = this.length;
          if (
            (this.length instanceof tU && (n = t.length),
            !(x.isBuffer(t) && n === t.length))
          ) {
            var i;
            throw TypeError(
              ((i = "Blob.encode"),
          ...
          return (
            ...
            this.length instanceof tU && this.length.encode(n, e, r),
            n
          );
        }
      }
      var tY = (t, e, r) => new tM(t, e, r),
        tX = (t) => new tV(1, t),
        tQ = (t) => new tV(4, t),
        t0 = (t) => new tz(t),
        t1 = (t, e, r) => new tF(t, e, r),
        t2 = (t, e, r) => new tG(t, e, r),
        t8 = (t, e) => new tZ(t, e);
      class t3 extends tN {
        constructor(t) {
          super(-1, t),
            (this.property = t),
            (this.layout = t1(
              [tQ("length"), tQ("lengthPadding"), t8(tY(tQ(), -8), "chars")],
              this.property
            ));
        }
        encode(t, e, r = 0) {
          if (null == t) return this.layout.span;
          let n = { chars: x.from(t, "utf8") };
        ...
        getSpan(t, e = 0) {
          return (
            tQ().span +
            tQ().span +
            new (y())(new Uint8Array(t).slice(e, e + 4), 10, "le").toNumber()
          );
        }
      }
      function t4(t) {
      ...
      let t5 = t2(tQ("instruction"));
      t5.addVariant(
        0,
        t1([t0("lamports"), t0("space"), t6("owner")]),
        "createAccount"
      ),
        t5.addVariant(1, t1([t6("owner")]), "assign"),
        t5.addVariant(2, t1([t0("lamports")]), "transfer"),
        t5.addVariant(
          3,
          t1([
            t6("base"),
        ...
        t5.addVariant(4, t1([t6("authorized")]), "advanceNonceAccount"),
        t5.addVariant(5, t1([t0("lamports")]), "withdrawNonceAccount"),
        t5.addVariant(6, t1([t6("authorized")]), "initializeNonceAccount"),
        t5.addVariant(7, t1([t6("authorized")]), "authorizeNonceAccount"),
        t5.addVariant(8, t1([t0("space")]), "allocate"),
        t5.addVariant(
          9,
          t1([t6("base"), t4("seed"), t0("space"), t6("owner")]),
          "allocateWithSeed"
        ),
        t5.addVariant(
          10,
          t1([t6("base"), t4("seed"), t6("owner")]),
          "assignWithSeed"
        ),
        t5.addVariant(
          11,
          t1([t0("lamports"), t4("seed"), t6("owner")]),
          "transferWithSeed"
        ),
        Object.values(t5.registry).map((t) => t.span);
      class t9 extends tN {
        constructor(t, e, r, n) {
          super(t.span, n),
            (this.layout = t),
      ...
      t1([
        ...
        t7("authorizedPubkey"),
        t7("nonce"),
        t1([new tK("lamportsPerSignature")], "feeCalculator"),
      ]);
      let et = new p.PublicKey("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"),
        ee = new p.PublicKey("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL");
      var er = { exports: {} };
      (a = er.exports),
        (c = "undefined" != typeof self ? self : tB),
        (l = u =
          (function () {
            function t() {
            ...
            return new Promise(function (i, o) {
              ...
              (c.onload = function () {
                ...
                (r.url =
                  ...
                  i(new g("response" in c ? c.response : c.responseText, r));
              }),
                (c.onerror = function () {
      ...
      let en = b.rustEnum(
        [
          b.struct([], "uninitialized"),
          b.struct([b.option(b.publicKey(), "authorityAddress")], "buffer"),
          b.struct([b.publicKey("programdataAddress")], "program"),
          b.struct(
            [b.u64("slot"), b.option(b.publicKey(), "upgradeAuthorityAddress")],
            "programData"
          ),
        ],
        void 0,
      ...
      async function ei(t) {
        let e = (await p.PublicKey.findProgramAddress([], t))[0];
        return await p.PublicKey.createWithSeed(e, "anchor:idl", t);
      }
      let eo = b.struct([b.publicKey("authority"), b.vecU8("data")]);
      function es(t, e) {
        var r, n;
        let i = {},
      ...
      class ea {
        static build(t, e, r) {
          if ("_inner" === t.name) throw new tu("the _inner name is reserved");
          let n = (...i) => {
            let [o, s] = es(t, [...i]);
            !(function t(e, r = {}) {
              e.forEach((e) => {
                if ("accounts" in e) t(e.accounts, r[e.name]);
                else if (void 0 === r[e.name])
                  throw Error(`Invalid arguments: ${e.name} not provided.`);
              });
            ...
            return (
              ...
              tc("debug-logs") && console.log("Outgoing account metas:", a),
          ...
          return (
            (n.accounts = (e) => ea.accountsArray(e, t.accounts, r, t.name)), n
          );
        }
            ...
            ? e
                .map((e) => {
                  if (void 0 !== ("accounts" in e ? e.accounts : void 0)) {
                    let i = t[e.name];
                    return ea.accountsArray(i, e.accounts, r, n).flat();
                  }
                  {
                    let i;
                    try {
      ...
      class ed {
        ...
        constructor(t, e, r, n, i) {
          (this._idlAccount = e),
            (this._programId = r),
            (this._provider = null != n ? n : to()),
            (this._coder = null != i ? i : new tO(t)),
        ...
        subscribe(t, e) {
          ...
          return eh.set(t.toString(), { ee: n, listener: i }), n;
        }
        async unsubscribe(t) {
          let e = eh.get(t.toString());
          if (!e) {
        ...
        async associatedAddress(...t) {
          return await (function (t, ...e) {
            ...
            e.forEach((t) => {
              r.push(t instanceof h.Buffer ? t : L(t).toBuffer());
            });
            let [n] = p.PublicKey.findProgramAddressSync(r, L(t));
            return n;
          })(this._programId, ...t);
        }
      ...
      class ev {
        ...
        *parseLogs(t, e = !1) {
        ...
        handleProgramLog(t, e) {
          if (!(t.startsWith(ep) || t.startsWith(ef)))
            return [null, ...this.handleSystemLog(t)];
          {
            let r = t.startsWith(ep) ? t.slice(ey) : t.slice(em),
      ...
      class e_ {
        static build(t, e, r, n, i, o, s) {
          return async (...a) => {
            ...
            let p = [];
            if (s.events) for (let t of new ev(o, i).parseLogs(h)) p.push(t);
            return { events: p, raw: h };
          };
        }
      }
      function eA(t) {
      ...
      class ex extends tN {
        constructor(t, e) {
          super(-1, e), (this.layout = t), (this.discriminator = tQ());
        }
        encode(t, e, r = 0) {
          return null == t
      ...
      let eP = t1([
        ...
        new ex(eE(), "delegate"),
        ((t) => {
          let e = t2(tX("discriminator"), null, t);
          return (
            e.addVariant(0, t1([]), "uninitialized"),
            e.addVariant(1, t1([]), "initialized"),
            e.addVariant(2, t1([]), "frozen"),
            e
          );
        })("state"),
        new ex(eA(), "isNative"),
        eA("delegatedAmount"),
        new ex(eE(), "closeAuthority"),
      ]);
      class ek {
        constructor(t, e, r, n, i, o, s, a) {
          (this._accounts = e),
            ...
            (this._args = t),
            (this._accountStore = new eT(r, o, this._programId));
        }
        args(t) {
          this._args = t;
        }
          ...
          for (let n of e) {
            ...
            void 0 !== i &&
              (eC(i)
                ...
                : null !== i
                ? (r[e] = L(i))
                : n.isOptional && (r[e] = this._programId));
          }
          return r;
        }
        resolveOptionals(t) {
        ...
        async resolveConst(t, e = []) {
          for (let r = 0; r < t.length; r += 1) {
            let n = t[r],
              i = n.accounts;
            i && (await this.resolveConst(i, [...e, w()(n.name)]));
            let o = w()(n.name);
            ...
            Reflect.has(ek.CONST_ACCOUNTS, o) &&
              !this.get([...e, o]) &&
              this.set([...e, o], ek.CONST_ACCOUNTS[o]);
          }
        }
        _resolveEventCpi(t, e = []) {
          for (let r in t) {
            let n = t[r],
              i = n.accounts;
            i && this._resolveEventCpi(i, [...e, w()(n.name)]);
            let o = +r + 1;
            if (o === t.length) return;
            let s = w()(t[r].name),
              a = w()(t[o].name);
            if ("eventAuthority" === s && "program" === a) {
              let t = [...e, s],
                r = [...e, a];
              this.get(t) ||
                this.set(
                  t,
                  p.PublicKey.findProgramAddressSync(
                    [x.from("__event_authority")],
                    this._programId
                  )[0]
                ),
        ...
        async resolvePdas(t, e = []) {
          ...
          for (let n = 0; n < t.length; n += 1) {
            let i = t[n],
              o = i.accounts;
            o && (r += await this.resolvePdas(o, [...e, w()(i.name)]));
            let s = w()(i.name);
            i.pda &&
              i.pda.seeds.length > 0 &&
              !this.get([...e, s]) &&
              (await this.autoPopulatePda(i, e)) &&
              (r += 1);
          }
          return r;
        }
        async resolveRelations(t, e = []) {
          ...
          for (let n = 0; n < t.length; n += 1) {
            let i = t[n],
              o = i.accounts;
            o && (r += await this.resolveRelations(o, [...e, w()(i.name)]));
            let s = i.relations || [],
              a = [...e, w()(i.name)],
              c = this.get(a);
            if (c) {
              let t = s.filter((t) => !this.get([...e, w()(t)]));
              if (((r += t.length), t.length > 0)) {
                let r = await this._accountStore.fetchAccount({ publicKey: c });
                await Promise.all(
                  t.map(async (t) => {
                    let n = w()(t);
        ...
        async autoPopulatePda(t, e = []) {
          ...
          let r = await Promise.all(
            t.pda.seeds.map((t) => this.toBuffer(t, e))
          );
          if (r.some((t) => void 0 === t)) return;
          let n = await this.parseProgramId(t, e);
          if (!n) return;
          let [i] = await p.PublicKey.findProgramAddress(r, n);
          this.set([...e, w()(t.name)], i);
        }
        async parseProgramId(t, e = []) {
          ...
          switch (t.pda.programId.kind) {
            case "const":
              return new p.PublicKey(this.toBufferConst(t.pda.programId.value));
            case "arg":
        ...
        parseAccountValue(t, e) {
          let r;
          for (; e.length > 0; ) (r = t[w()(e[0])]), (e = e.slice(1));
          return r;
        }
        toBufferValue(t, e) {
          switch (t) {
            ...
            case "string":
              var o;
              return x.from(((o = e), new TextEncoder().encode(o)));
            case "publicKey":
              return e.toBuffer();
            default:
              if (t.array) return x.from(e);
              throw Error(`Unexpected seed type: ${t}`);
          }
        }
      }
      ek.CONST_ACCOUNTS = {
        associatedTokenProgram: ee,
        rent: p.SYSVAR_RENT_PUBKEY,
        systemProgram: p.SystemProgram.programId,
        tokenProgram: et,
        clock: p.SYSVAR_CLOCK_PUBKEY,
      };
      class eT {
        constructor(t, e, r) {
          (this._provider = t),
        ...
        async ensureIdl(t) {
          if (!this._idls[t.toBase58()]) {
            let e = await eR.fetchIdl(t, this._provider);
            if (e) {
              let r = new eR(e, t, this._provider);
      ...
      class eL {
        static build(t, e, r, n, i, o, s, a, c, u, l) {
          return (...d) => new eD(d, n, i, o, s, a, t, e, r, c, u, l);
        }
      }
      function eC(t) {
      ...
      class eD {
        ...
        preInstructions(t) {
          return (
            (this._preInstructions = this._preInstructions.concat(t)), this
          );
        }
        postInstructions(t) {
          return (
        ...
        static build(t, e, r, n) {
          ...
          if (!i && o)
            return async (...i) => {
              ...
              let a = await r(...i),
                c = `Program return: ${t} `,
                u = a.raw.find((t) => t.startsWith(c));
              if (!u) throw Error("View expected return log");
              let l = T(u.slice(c.length)),
                d = e.returns;
              if (!d) throw Error("View expected return type");
              return tA
                .fieldLayout(
                  { type: d },
                  Array.from([
                    ...(null !== (o = n.accounts) && void 0 !== o ? o : []),
                    ...(null !== (s = n.types) && void 0 !== s ? s : []),
                  ])
                )
                .decode(l);
            };
      ...
      class eB {
        static build(t, e, r, n, i) {
          let o = {},
            ...
            h = t.accounts ? el.build(t, e, r, n) : {};
          return (
            t.instructions.forEach((p) => {
              let f = ea.build(p, (t, r) => e.instruction.encode(t, r), r),
                y = ec.build(p, f),
                m = eu.build(p, y, d, n),
                g = e_.build(p, y, d, n, e, r, t),
                v = eO.build(r, p, g, t),
                b = eL.build(
                  n,
                  r,
      ...
      class eR {
        ...
        constructor(t, e, r, n, i) {
          (e = L(e)),
            ...
            (this._provider = r),
            (this._programId = e),
            (this._coder = null != n ? n : new tO(t)),
            (this._events = new eg(this._programId, r, this._coder));
          let [o, s, a, c, u, l, d] = eB.build(
            t,
            this._coder,
            e,
            r,
        ...
        static async fetchIdl(t, e) {
          ...
          if (!s) return null;
          let a = ((r = s.data.slice(8)), eo.decode(r));
          return JSON.parse(
            ((n = (0, A.rr)(a.data)), new TextDecoder("utf-8").decode(n))
          );
        }
        addEventListener(t, e) {
      ...
      new p.PublicKey("11111111111111111111111111111111");
    },
  },
]);
