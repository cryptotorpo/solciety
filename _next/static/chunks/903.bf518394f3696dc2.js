(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [903],
  {
        ...
        for (var a, c, u = new Uint8Array(64), h = 0; h < r.length; h += 64) {
          !(function (e, t, r) {
            ...
            i.writeUint32LE((y + 1634760805) | 0, e, 0),
              ...
              i.writeUint32LE((C + l) | 0, e, 44),
              i.writeUint32LE((O + f) | 0, e, 48),
          ...
          (e.prototype._blocks = function (e, t, r) {
            for (
              ...
              (N =
                ...
                (I &= 8191);
              var k = N;
              (k += n * g + s * d + 5 * D * o + 5 * E * a + 5 * _ * c),
                (N = k >>> 13),
                (k &= 8191),
                (k +=
                  5 * w * u + 5 * b * h + 5 * m * l + 5 * v * f + 5 * y * p),
                (N += k >>> 13),
                (k &= 8191);
              var j = N;
              ...
              (M += n * m + s * v + o * y + a * g + c * d),
                ...
                (M &= 8191),
                (M +=
                  5 * D * u + 5 * E * h + 5 * _ * l + 5 * w * f + 5 * b * p),
                (N += M >>> 13),
                (M &= 8191);
              var U = N;
              (U += n * b + s * m + o * v + a * y + c * g),
                (N = U >>> 13),
                (U &= 8191),
                (U += u * d + 5 * D * h + 5 * E * l + 5 * _ * f + 5 * w * p),
                (N += U >>> 13),
                (U &= 8191);
              var q = N;
              (q += n * w + s * b + o * m + a * v + c * y),
                (N = q >>> 13),
                (q &= 8191),
                (q += u * g + h * d + 5 * D * l + 5 * E * f + 5 * _ * p),
                (N += q >>> 13),
                (q &= 8191);
              var z = N;
              (z += n * _ + s * w + o * b + a * m + c * v),
                (N = z >>> 13),
                (z &= 8191),
                (z += u * y + h * g + l * d + 5 * D * f + 5 * E * p),
                (N += z >>> 13),
                (z &= 8191);
              var $ = N;
              ($ += n * E + s * _ + o * w + a * b + c * m),
                (N = $ >>> 13),
                ($ &= 8191),
                ($ += u * v + h * y + l * g + f * d + 5 * D * p),
                (N += $ >>> 13),
                ($ &= 8191);
              var B = N;
              (B += n * D + s * E + o * _ + a * w + c * b),
                (N = B >>> 13),
                (B &= 8191),
                (B += u * m + h * v + l * y + f * g + p * d),
                (N += B >>> 13),
                (B &= 8191),
    ...
    5010: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      let i = r(7297);
      i.__exportStar(r(45086), t), i.__exportStar(r(64250), t);
    },
    7297: function (e, t, r) {
      "use strict";
      r.r(t),
...
***************************************************************************** */ var i =
    ...
    10666: function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      let i = r(52388);
      i.__exportStar(r(88914), t),
        i.__exportStar(r(1415), t),
        i.__exportStar(r(28580), t),
        i.__exportStar(r(27025), t);
    },
    28580: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        r(52388).__exportStar(r(5955), t);
    },
    5955: function (e, t) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
...
***************************************************************************** */ var i =
    ...
    33958: function (e, t, r) {
      ...
      var M = Array.prototype,
        ...
        $ = U.toString,
        B = q.hasOwnProperty,
        F = (i = /[^.]+$/.exec((z && z.keys && z.keys.IE_PROTO) || ""))
          ? "Symbol(src)_1." + i
          : "",
        H = q.toString,
        V = RegExp(
      ...
      function eD(e) {
        ...
        return (
          (t = (function (e) {
            return null != e && ek(e.length) && !eN(e)
              ? (function (e, t) {
                  var r,
                    i = eR(e),
                    n = !i && ex(e),
      ...
      function eS(e, t) {
        ...
        return !(!ej(r) || (F && F in r)) && (eN(r) ? V : D).test(eO(r))
          ? r
          : void 0;
      }
      ...
      var ex = e_(
          ...
          ? e_
          : function (e) {
              return eL(e) && B.call(e, "callee") && !Y.call(e, "callee");
            },
        eR = Array.isArray,
        eT =
          Z ||
      ...
      var eM = k
        ...
        : function (e) {
            return eL(e) && ek(e.length) && !!S[ew(e)];
          };
      e.exports = function (e, t) {
    ...
    5563: function (e, t, r) {
                  ...
                  return n.getItemRaw
                    ...
                    : p(n.getItem, i, t).then((e) =>
                        "string" == typeof e && e.startsWith(g)
                          ? f.from(e.slice(g.length), "base64")
                          : e
                      );
                },
                async setItem(e, t, i = {}) {
      ...
      class F extends z {
        ...
        async initialize() {
          this.intervalRef = setInterval(
            () => this.pulse(),
            (0, U.toMiliseconds)(this.interval)
          );
        }
        pulse() {
          this.events.emit(B.pulse);
        }
      }
      var H = r(69413),
        V = r.n(H);
      ...
      class J {
        ...
        appendToLogs(e) {
          this.logs.append(O({ timestamp: new Date().toISOString(), log: e }));
      ...
      var eC = r(31080),
        ...
        eA = r(28807);
      function ex(e) {
        return (0, eO.B)((0, eA.m)(O(e), "utf8"), eS);
      }
      function eR(e) {
        let t = (0, eA.m)("K36", eP);
        return ["did", "key", "z" + (0, eO.B)((0, eC.z)([t, e]), eP)].join(":");
      }
      function eT(e = (0, eI.randomBytes)(32)) {
        return eD._w(e);
      }
      async function eN(e, t, r, i, n = (0, U.fromMiliseconds)(Date.now())) {
        var s, o, a;
        let c = { alg: "EdDSA", typ: "JWT" },
          u = { iss: eR(i.publicKey), sub: e, aud: t, iat: n, exp: n + r },
          h =
            ((s = { header: c, payload: u }),
            (0, eA.m)([ex(s.header), ex(s.payload)].join("."), "utf8"));
        return [
          ex(
            (o = { header: c, payload: u, signature: eD.Xx(i.secretKey, h) })
              .header
          ),
          ex(o.payload),
          ((a = o.signature), (0, eO.B)(a, eS)),
        ].join(".");
      }
      r(3947);
      var ek = r(74013);
      let ej = "INTERNAL_ERROR",
        ...
        eU = {
          ...
          [ej]: { code: -32603, message: "Internal error" },
          [eL]: { code: -32e3, message: "Server error" },
        };
      function eq(e) {
        return Object.keys(eU).includes(e) ? eU[e] : eU[eL];
      }
      function ez(e, t, r) {
      ...
      function eH(e, t, r) {
        return { id: r || eB(), jsonrpc: "2.0", method: e, params: t };
      }
      function eV(e, t) {
        ...
        return {
          ...
          error:
            void 0 === (i = t)
              ? eq(ej)
              : ("string" == typeof i &&
                  (i = Object.assign(Object.assign({}, eq(eL)), {
                    message: i,
                  })),
                void 0 !== r && (i.data = r),
                (n = i.code),
                eM.includes(n) &&
                  ((s = i.code),
                  (i = Object.values(eU).find((e) => e.code === s) || eU[eL])),
                i),
        };
      }
      class eW {}
      ...
      class e6 extends eY {
        ...
        async request(e, t) {
          return this.requestStrict(
            eH(e.method, e.params || [], e.id || eF().toString()),
            t
          );
        }
      ...
      class tf {
        constructor(e, t, r, i) {
          (this.name = e),
            ...
            (this.baseEncode = r),
            (this.baseDecode = i),
            (this.encoder = new tc(e, t, r)),
            (this.decoder = new tu(e, t, i));
        }
        encode(e) {
      ...
      let tp = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new tf(e, t, r, i),
        td = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: n } = tn(r, t);
          return tp({ prefix: e, name: t, encode: i, decode: (e) => ts(n(e)) });
        },
        tg = (e, t, r, i) => {
          let n = {};
      ...
      let tk = Array.from(
        ...
        tj = tk.reduce((e, t, r) => ((e[r] = t), e), []),
        tL = tk.reduce((e, t, r) => ((e[t.codePointAt(0)] = r), e), []);
      var tM = Object.freeze({
          __proto__: null,
          base256emoji: tp({
            prefix: "\uD83D\uDE80",
      ...
      let tq = (e, t, r = 0) => (tU.encode(e, t, r), t),
        tz = (e) => tU.encodingLength(e),
        t$ = (e, t) => {
          let r = t.byteLength,
            i = tz(e),
            n = i + tz(r),
            s = new Uint8Array(n + r);
          return tq(e, s, 0), tq(r, s, i), s.set(t, n), new tB(e, r, t, s);
        };
      class tB {
        constructor(e, t, r, i) {
      ...
      let tF = ({ name: e, code: t, encode: r }) => new tH(e, t, r);
      class tH {
        constructor(e, t, r) {
      ...
      var tK = Object.freeze({
          __proto__: null,
          sha256: tF({ name: "sha2-256", code: 18, encode: tV("SHA-256") }),
          sha512: tF({ name: "sha2-512", code: 19, encode: tV("SHA-512") }),
        }),
        tW = Object.freeze({
          __proto__: null,
          identity: {
      ...
      let tJ = tY(
        ...
        t6 = U.ONE_DAY,
        t2 = U.SIX_HOURS,
        t8 = "wss://relay.walletconnect.com",
        t4 = "wss://relay.walletconnect.org",
        t9 = {
        ...
        ra = "verify-api",
        rc = "https://verify.walletconnect.com",
        ru = "https://verify.walletconnect.org",
        rh = [rc, ru];
      class rl {
        constructor(e, t) {
          (this.core = e),
        ...
        isInitialized() {
          if (!this.initialized) {
            let { message: e } = (0, o.kCb)("NOT_INITIALIZED", this.name);
            throw Error(e);
          }
        }
      }
      class rf {
        constructor(e, t, r) {
          (this.core = e),
            ...
            (this.getClientId = async () => (
              this.isInitialized(), eR(eT(await this.getClientSeed()).publicKey)
            )),
            ...
            (this.signJWT = async (e) => {
              this.isInitialized();
              let t = eT(await this.getClientSeed()),
                r = (0, o.jdp)();
              return await eN(r, e, t6, t);
            }),
            ...
            (this.getPayloadSenderPublicKey = (e) => {
              ...
              return t.senderPublicKey
                ? (0, ek.BB)(t.senderPublicKey, o.AWt)
                : void 0;
            }),
            (this.core = e),
            (this.logger = eh(t, this.name)),
            (this.keychain = r || new rl(this.core, this.logger));
        }
        get context() {
          return eu(this.logger);
        }
        ...
        async getClientSeed() {
          ...
          try {
            ...
            (e = (0, o.jdp)()), await this.keychain.set(t3, e);
          }
      ...
      class rp extends ep {
        constructor(e, t) {
          super(e, t),
            ...
            (this.has = (e, t) => (
              this.isInitialized(), "u" > typeof this.get(e)[(0, o.rjm)(t)]
            )),
            (this.del = async (e) => {
              this.isInitialized(),
      ...
      class rd extends ed {
        constructor(e, t) {
          super(e, t),
            ...
            (this.name = "publisher"),
            (this.queue = new Map()),
            (this.publishTimeout = (0, U.toMiliseconds)(U.ONE_MINUTE)),
            (this.failedPublishTimeout = (0, U.toMiliseconds)(U.ONE_SECOND)),
            ...
            (this.publish = async (e, t, r) => {
              ...
              let n = r?.ttl || t2,
                ...
                h = {
                  topic: e,
                  message: t,
                  opts: { ttl: n, relay: s, prompt: a, tag: c, id: u },
                },
              ...
              try {
                for (; void 0 === p; ) {
                  ...
                  this.logger.trace(
                    ...
                    (p = await await (0, o.hFY)(
                      this.rpcPublish(e, t, n, s, a, c, u).catch((e) =>
                        this.logger.warn(e)
                      ),
                      this.publishTimeout,
                      l
                ...
                this.relayer.events.emit(t9.publish, h),
                  this.logger.debug("Successfully Published Payload"),
                  this.logger.trace({
                    type: "method",
                    method: "publish",
                    params: { id: u, topic: e, message: t, opts: r },
                  });
              } catch (e) {
                if (
        ...
        rpcPublish(e, t, r, i, n, s, a) {
          ...
          return (
            (0, o.o8e)(null == (c = f.params) ? void 0 : c.prompt) &&
              (null == (u = f.params) || delete u.prompt),
            (0, o.o8e)(null == (h = f.params) ? void 0 : h.tag) &&
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(B.pulse, () => {
            if (this.needsTransportRestart) {
              (this.needsTransportRestart = !1),
                this.relayer.events.emit(t9.connection_stalled);
              return;
            }
            this.checkQueue();
          }),
            this.relayer.on(t9.message_ack, (e) => {
      ...
      var ry = Object.defineProperty,
        ...
        rE = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        rD = (e, t) => {
          for (var r in t || (t = {})) rw.call(t, r) && rE(e, r, t[r]);
          if (rb) for (var r of rb(t)) r_.call(t, r) && rE(e, r, t[r]);
          return e;
        },
        rI = (e, t) => rv(e, rm(t));
      class rS extends ev {
        constructor(e, t) {
          super(e, t),
            ...
            (this.storagePrefix = t0),
            (this.subscribeTimeout = (0, U.toMiliseconds)(U.ONE_MINUTE)),
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, rI(rD({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, rD({}, e)),
        ...
        addSubscription(e, t) {
          this.subscriptions.set(e, rD({}, t)),
            this.topicMap.set(t.topic, e),
            this.events.emit(rt.created, t);
        }
        getSubscription(e) {
        ...
        deleteSubscription(e, t) {
          ...
          this.subscriptions.delete(e),
            ...
            this.events.emit(rt.deleted, rI(rD({}, r), { reason: t }));
        }
        async persist() {
          await this.setRelayerSubscriptions(this.values),
            this.events.emit(rt.sync);
        }
        async reset() {
        ...
        async batchSubscribe(e) {
          ...
          (0, o.qt8)(t) &&
            this.onBatchSubscribe(t.map((t, r) => rI(rD({}, e[r]), { id: t })));
        }
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(B.pulse, async () => {
      ...
      var rP = Object.defineProperty,
        ...
        rx = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        rR = (e, t) => {
          for (var r in t || (t = {})) rO.call(t, r) && rx(e, r, t[r]);
          if (rC) for (var r of rC(t)) rA.call(t, r) && rx(e, r, t[r]);
          return e;
        };
      class rT extends eg {
        constructor(e) {
          super(e),
            ...
            (this.heartBeatTimeout = (0, U.toMiliseconds)(
              U.THIRTY_SECONDS + U.ONE_SECOND
            )),
            (this.request = async (e) => {
              ...
              try {
                ...
                let s = await new Promise(async (e, t) => {
                  ...
                  this.provider.on(t7.disconnect, r);
                  let s = await n;
                  this.provider.off(t7.disconnect, r), e(s);
                });
                return (
                  this.logger.trace(
                    {
            ...
            (this.onConnectHandler = () => {
              this.startPingTimeout(), this.events.emit(t9.connect);
            }),
            ...
            (this.registerProviderListeners = () => {
              this.provider.on(t7.payload, this.onPayloadHandler),
                this.provider.on(t7.connect, this.onConnectHandler),
                this.provider.on(t7.disconnect, this.onDisconnectHandler),
                this.provider.on(t7.error, this.onProviderErrorHandler);
            }),
            (this.core = e.core),
            (this.logger =
              "u" > typeof e.logger && "string" != typeof e.logger
                ? eh(e.logger, this.name)
                : V()(ec({ level: e.logger || "error" }))),
            (this.messages = new rp(this.logger, e.core)),
            (this.subscriber = new rS(this, this.logger)),
            (this.publisher = new rd(this, this.logger)),
            (this.relayUrl = e?.relayUrl || t8),
            (this.projectId = e.projectId),
            (this.bundleId = (0, o.X_B)()),
            (this.provider = {});
        }
        async init() {
          this.logger.trace("Initialized"),
          ...
          try {
            ...
            this.logger.warn(
              `Connection via ${this.relayUrl} failed, attempting to connect via failover domain ${t4}...`
            ),
              await this.restartTransport(t4);
          }
          (this.initialized = !0),
            setTimeout(async () => {
        ...
        async subscribe(e, t) {
          ...
          let i =
            ...
            n,
            s = (t) => {
              t.topic === e && (this.subscriber.off(rt.created, s), n());
            };
          return (
            await Promise.all([
              new Promise((e) => {
                (n = e), this.subscriber.on(rt.created, s);
              }),
              new Promise(async (r) => {
        ...
        async transportOpen(e) {
          ...
          try {
            await new Promise(async (e, t) => {
              let r = () => {
                this.provider.off(t7.disconnect, r),
                  t(Error("Connection interrupted while trying to subscribe"));
              };
              this.provider.on(t7.disconnect, r),
                await (0, o.hFY)(
                  this.provider.connect(),
                  (0, U.toMiliseconds)(U.ONE_MINUTE),
        ...
        async onProviderPayload(e) {
          if (
            ...
            this.logger.debug("Emitting Relayer Payload"),
              this.logger.trace(rR({ type: "event", event: t.id }, s)),
              this.events.emit(t.id, s),
              await this.acknowledgePayload(e),
              await this.onMessageEvent(s);
          } else e1(e) && this.events.emit(t9.message_ack, e);
        }
        async onMessageEvent(e) {
          (await this.shouldIgnoreMessageEvent(e)) ||
            (this.events.emit(t9.message, e), await this.recordMessageEvent(e));
        }
        ...
        unregisterProviderListeners() {
          this.provider.off(t7.payload, this.onPayloadHandler),
            this.provider.off(t7.connect, this.onConnectHandler),
            this.provider.off(t7.disconnect, this.onDisconnectHandler),
            this.provider.off(t7.error, this.onProviderErrorHandler),
            clearTimeout(this.pingTimeout);
        }
      ...
      var rN = Object.defineProperty,
        ...
        rM = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        rU = (e, t) => {
          for (var r in t || (t = {})) rj.call(t, r) && rM(e, r, t[r]);
          if (rk) for (var r of rk(t)) rL.call(t, r) && rM(e, r, t[r]);
          return e;
        };
      class rq extends ey {
        constructor(e, t, r, i = t0, n) {
          super(e, t, r, i),
            (this.core = e),
            (this.logger = t),
            (this.name = r),
            ...
            (this.init = async () => {
              this.initialized ||
                ...
                this.cached.forEach((e) => {
                  this.getKey && null !== e && !(0, o.o8e)(e)
                    ? this.map.set(this.getKey(e), e)
                    : (0, o.xWS)(e)
                    ? this.map.set(e.id, e)
                    : (0, o.h1R)(e) && this.map.set(e.topic, e);
                }),
                (this.cached = []),
                (this.initialized = !0));
            }),
            ...
            (this.getAll = (e) => (
              ...
              e
                ? this.values.filter((t) =>
                    Object.keys(e).every((r) => te()(t[r], e[r]))
                  )
                : this.values
            )),
      ...
      class rz {
        constructor(e, t) {
          (this.core = e),
            ...
            (this.initialized = !1),
            (this.storagePrefix = t0),
            (this.ignoredPayloadTypes = [o.rVF]),
            ...
            (this.ping = async (e) => {
              ...
              if (this.pairings.keys.includes(t)) {
                let e = await this.sendRequest(t, "wc_pairingPing", {}),
                  { done: r, resolve: i, reject: n } = (0, o.H1S)();
                this.events.once(
                  (0, o.E0T)("pairing_ping", e),
                  ({ error: e }) => {
                    e ? n(e) : i();
                  }
                ),
            ...
            (this.sendResult = async (e, t, r) => {
              let i = eV(e, r),
                ...
                s = ri[(await this.core.history.get(t, e)).request.method].res;
            ...
            (this.sendError = async (e, t, r) => {
              let i = eK(e, r),
                ...
                o = ri[s.request.method]
                  ? ri[s.request.method].res
                  : ri.unregistered_method.res;
            ...
            (this.deletePairing = async (e, t) => {
              await this.core.relayer.unsubscribe(e),
                await Promise.all([
                  this.pairings.delete(e, (0, o.D6H)("USER_DISCONNECTED")),
            ...
            (this.onPairingPingRequest = async (e, t) => {
              ...
              try {
                this.isValidPing({ topic: e }),
                  ...
                  this.events.emit(rn.ping, { id: r, topic: e });
              } catch (t) {
            ...
            (this.onPairingPingResponse = (e, t) => {
              ...
              setTimeout(() => {
                e5(t)
                  ? this.events.emit((0, o.E0T)("pairing_ping", r), {})
                  : e3(t) &&
                    this.events.emit((0, o.E0T)("pairing_ping", r), {
                      error: t.error,
                    });
            ...
            (this.onUnknownRpcMethodResponse = (e) => {
              this.registeredMethods.includes(e) ||
                this.logger.error((0, o.D6H)("WC_METHOD_UNSUPPORTED", e));
            }),
            (this.isValidPair = (e) => {
              var t;
              if (!(0, o.EJd)(e)) {
        ...
        registerRelayerEvents() {
          this.core.relayer.on(t9.message, async (e) => {
            let { topic: t, message: r } = e;
            if (
              !this.pairings.keys.includes(t) ||
        ...
        registerExpirerEvents() {
          this.core.expirer.on(ro.expired, async (e) => {
            let { topic: t } = (0, o.iPz)(e.target);
            t &&
              this.pairings.keys.includes(t) &&
              (await this.deletePairing(t, !0),
              this.events.emit(rn.expire, { topic: t }));
          });
        }
      }
      class r$ extends ef {
        ...
        get pending() {
          ...
          return (
            this.values.forEach((t) => {
              ...
              let r = {
                topic: t.topic,
                request: eH(t.request.method, t.request.params, t.id),
                chainId: t.chainId,
              };
              return e.push(r);
            }),
        ...
        async persist() {
          await this.setJsonRpcRecords(this.values), this.events.emit(rs.sync);
        }
        async restore() {
          try {
        ...
        registerEventListeners() {
          this.events.on(rs.created, (e) => {
            let t = rs.created;
            this.logger.info(`Emitting ${t}`),
              this.logger.debug({ type: "event", event: t, record: e });
          }),
            this.events.on(rs.updated, (e) => {
              let t = rs.updated;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, record: e });
            }),
            ...
            this.core.heartbeat.on(B.pulse, () => {
              this.cleanup();
            });
        }
        cleanup() {
          try {
            ...
            this.records.forEach((t) => {
              (0, U.toMiliseconds)(t.expiry || 0) - Date.now() <= 0 &&
                ...
                this.events.emit(rs.deleted, t, !1),
                (e = !0));
            }),
              e && this.persist();
          } catch (e) {
      ...
      class rB extends em {
          ...
          super(e, t),
            ...
            (this.set = (e, t) => {
              ...
              this.expirations.set(r, i),
                ...
                this.events.emit(ro.created, { target: r, expiration: i });
            }),
            (this.get = (e) => {
              this.isInitialized();
              let t = this.formatTarget(e);
            ...
            (this.del = (e) => {
              if ((this.isInitialized(), this.has(e))) {
                ...
                this.expirations.delete(t),
                  this.events.emit(ro.deleted, { target: t, expiration: r });
              }
            }),
            (this.on = (e, t) => {
              this.events.on(e, t);
        ...
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(ro.expired, { target: e, expiration: t });
        }
        checkExpirations() {
        ...
        registerEventListeners() {
          this.core.heartbeat.on(B.pulse, () => this.checkExpirations()),
            this.events.on(ro.created, (e) => {
              let t = ro.created;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                this.persist();
        ...
        constructor(e, t) {
          super(e, t),
            ...
            (this.init = async (e) => {
              ...
              if (!this.initialized) {
                this.removeIframe(), (this.verifyUrl = ru);
                try {
                  await this.createIframe();
                } catch (e) {
                  this.logger.info(
            ...
            (this.resolve = async (e) => {
              ...
              try {
                ...
                this.logger.info(
                  ...
                  this.logger.info(i),
                  (t = await this.fetchAttestation(e.attestationId, ru));
              }
              return t;
            }),
            ...
            (this.createIframe = async () => {
              ...
              await Promise.race([
                new Promise((r) => {
                  let i = document.getElementById(ra);
            ...
            (this.getVerifyUrl = (e) => {
              ...
              return (
                rh.includes(t) ||
                  (this.logger.info(
                    `verify url: ${t}, not included in trusted list, assigning default: ${rc}`
                  ),
                  (t = rc)),
                t
              );
            ...
            (this.isDevEnv = (0, o.UGU)() && ti.env.IS_VITEST);
        }
        get context() {
          return eu(this.logger);
        }
      ...
      var rV = Object.defineProperty,
        ...
        rJ = (e, t) => {
          ...
          if (rK) for (var r of rK(t)) rG.call(t, r) && rY(e, r, t[r]);
          return e;
        };
      class rQ extends el {
        constructor(e) {
          ...
          super(e),
            ...
            (this.customStoragePrefix =
              null != e && e.customStoragePrefix
                ...
                : "");
          let { logger: i, chunkLoggerController: s } =
            "u" >
              typeof (r = {
                opts: ec({
                  level:
                    "string" == typeof e?.logger && e.logger
                      ? e.logger
                      : t1.logger,
                }),
          ...
          (this.logChunkController = s),
            ...
            (this.logger = eh(i, this.name)),
            (this.heartbeat = new F()),
            (this.crypto = new rf(this, this.logger, e?.keychain)),
            (this.history = new r$(this, this.logger)),
            (this.expirer = new rB(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new M(rJ(rJ({}, t5), e?.storageOptions))),
            (this.relayer = new rT({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new rz(this, this.logger)),
            (this.verify = new rF(this.projectId || "", this.logger)),
            (this.echoClient = new rH(this.projectId || "", this.logger));
        }
        static async init(e) {
          let t = new rQ(e);
          await t.initialize();
      ...
      let rX = "client",
        ...
        r6 = {
          ...
          wc_sessionPing: {
            req: { ttl: U.ONE_DAY, prompt: !1, tag: 1114 },
            res: { ttl: U.ONE_DAY, prompt: !1, tag: 1115 },
          },
        ...
        r2 = { min: U.FIVE_MINUTES, max: U.SEVEN_DAYS },
        r8 = { idle: "IDLE", active: "ACTIVE" },
        r4 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest"],
        r9 = "wc@1.5:auth:",
        r7 = `${r9}:PUB_KEY`;
      var ie = Object.defineProperty,
        ...
        ic = (e, t) => {
          ...
          if (ii) for (var r of ii(t)) io.call(t, r) && ia(e, r, t[r]);
          return e;
        },
        iu = (e, t) => it(e, ir(t));
      class ih extends eE {
        constructor(e) {
          super(e),
            ...
            (this.events = new (s())()),
            (this.initialized = !1),
            (this.requestQueue = { state: r8.idle, queue: [] }),
            (this.sessionRequestQueue = { state: r8.idle, queue: [] }),
            (this.requestQueueDelay = U.ONE_SECOND),
            ...
            (this.init = async () => {
              this.initialized ||
                ...
                this.client.core.pairing.register({ methods: Object.keys(r6) }),
                (this.initialized = !0),
                setTimeout(() => {
            ...
            (this.connect = async (e) => {
              ...
              let l = await this.client.core.crypto.generateKeyPair(),
                f = r6.wc_sessionPropose.req.ttl || U.FIVE_MINUTES,
                p = (0, o.gn4)(f),
                d = ic(
                  {
                    requiredNamespaces: i,
                ...
                { reject: g, resolve: y, done: v } = (0, o.H1S)(f, r5);
              this.events.once(
                (0, o.E0T)("session_connect"),
              ...
              return (
                await this.setProposal(m, ic({ id: m }, d)),
                { uri: u, approval: v }
              );
            }),
            (this.pair = async (e) => {
            ...
            (this.approve = async (e) => {
              ...
              return (
                ...
                await this.setExpiry(d, (0, o.gn4)(r3)),
                {
                  topic: d,
                  acknowledged: () =>
                    new Promise((e) =>
            ...
            (this.update = async (e) => {
              ...
              let { topic: t, namespaces: r } = e,
                { done: i, resolve: n, reject: s } = (0, o.H1S)(),
                a = eB(),
                c = eF().toString(),
                u = this.client.session.get(t).namespaces;
              return (
                this.events.once(
                  (0, o.E0T)("session_update", a),
                  ({ error: e }) => {
                    e ? s(e) : n();
                  }
                ),
                ...
                await this.sendRequest({
                  ...
                  this.client.logger.error(e),
                    this.client.session.update(t, { namespaces: u }),
                    s(e);
                }),
                { acknowledged: i }
              );
            ...
            (this.extend = async (e) => {
              ...
              return (
                this.events.once(
                  (0, o.E0T)("session_extend", r),
                  ({ error: e }) => {
                    e ? s(e) : n();
                  }
                ),
                await this.setExpiry(t, (0, o.gn4)(r3)),
                this.sendRequest({
                  topic: t,
            ...
            (this.request = async (e) => {
              ...
              let {
                  ...
                  request: r,
                  topic: i,
                  expiry: n = r6.wc_sessionRequest.req.ttl,
                } = e,
                ...
                await Promise.all([
                  ...
                  new Promise(async (e) => {
                    ...
                    if (!(null != (t = s.sessionConfig) && t.disableDeepLink)) {
                      let e = await (0, o.bW6)(this.client.core.storage, r1);
                      (0, o.HhN)({ id: a, topic: i, wcDeepLink: e });
                    }
                    e();
                  }),
                  u(),
            ...
            (this.find = (e) => (
              this.isInitialized(),
              this.client.session.getAll().filter((t) => (0, o.Ih8)(t, e))
            )),
            (this.getPendingSessionRequests = () =>
            ...
            (this.authenticate = async (e) => {
              ...
              if (
                (await Promise.all([
                  this.client.auth.authKeys.set(r7, {
                    responseTopic: y,
                    publicKey: g,
                  }),
                ...
                let { namespace: e } = (0, o.DQe)(t[0]),
                  r = (0, o.IkP)(e, "request", h);
                (0, o.hA9)(f) && (r = (0, o.qJM)(r, f.pop())), f.push(r);
              }
              let v =
                  l && l > r6.wc_sessionAuthenticate.req.ttl
                    ? l
                    : r6.wc_sessionAuthenticate.req.ttl,
                m = {
                  authPayload: {
                    type: a ?? "caip122",
                    chains: t,
                ...
                b = {
                  ...
                  expiryTimestamp: (0, o.gn4)(r6.wc_sessionPropose.req.ttl),
                },
                {
                  done: w,
                  resolve: _,
                ...
                D = async ({ error: e, session: t }) => {
                  if ((this.events.off((0, o.E0T)("session_request", S), I), e))
                    E(e);
                  else if (t) {
                    (t.self.publicKey = g),
                    ...
                    await this.deleteProposal(P), _({ session: e });
                  }
                },
                I = async (e) => {
                  let t;
                  if (
                    (await this.deletePendingAuthRequest(S, {
                      message: "fulfilled",
                      code: 0,
                    }),
                    e.error)
                    ...
                    return e.error.code === t.code
                      ? void 0
                      : (this.events.off((0, o.E0T)("session_connect"), D),
                        E(e.error.message));
                  }
                ...
                S = eB(),
                P = eB();
              this.events.once((0, o.E0T)("session_connect"), D),
                this.events.once((0, o.E0T)("session_request", S), I);
              try {
                await Promise.all([
                  this.sendRequest({
                    topic: p,
                  ...
                  this.sendRequest({
                    ...
                    method: "wc_sessionPropose",
                    params: b,
                    expiry: r6.wc_sessionPropose.req.ttl,
                    throwOnFailedPublish: !0,
                    clientRpcId: P,
                  }),
                ]);
                ...
                throw (
                  (this.events.off((0, o.E0T)("session_connect"), D),
                  this.events.off((0, o.E0T)("session_request", S), I),
                  e)
                );
              }
              return (
                await this.setProposal(P, ic({ id: P }, b)),
                await this.setAuthRequest(S, {
                  request: iu(ic({}, m), { verifyContext: {} }),
                  pairingTopic: p,
                }),
                { uri: d, response: w }
              );
            ...
            (this.approveSessionAuthenticate = async (e) => {
              ...
              let s = n.requester.publicKey,
                ...
                c = (0, o.YmJ)(s),
                u = { type: o.rVF, receiverPublicKey: s, senderPublicKey: a },
                h = [],
                l = [];
              for (let e of i) {
                if (
            ...
            (this.rejectSessionAuthenticate = async (e) => {
              ...
              let n = i.requester.publicKey,
                ...
                a = (0, o.YmJ)(n),
                c = { type: o.rVF, receiverPublicKey: n, senderPublicKey: s };
              await this.sendError({
                id: t,
                topic: a,
                error: r,
            ...
            (this.deleteProposal = async (e, t) => {
              await Promise.all([
                this.client.proposal.delete(e, (0, o.D6H)("USER_DISCONNECTED")),
            ...
            (this.deletePendingSessionRequest = async (e, t, r = !1) => {
              await Promise.all([
                ...
                r &&
                  ((this.sessionRequestQueue.state = r8.idle),
            ...
            (this.setProposal = async (e, t) => {
              this.client.core.expirer.set(
                e,
                (0, o.gn4)(r6.wc_sessionPropose.req.ttl)
              ),
            ...
            (this.setPendingSessionRequest = async (e) => {
              let { id: t, topic: r, params: i, verifyContext: n } = e,
                s =
                  ...
                  (0, o.gn4)(r6.wc_sessionRequest.req.ttl);
            ...
            (this.sendResult = async (e) => {
              ...
              let u = r6[r.request.method].res;
              o
                ? ((u.internal = iu(ic({}, u.internal), {
                    throwOnFailedPublish: !0,
                  })),
                  await this.client.core.relayer.publish(n, t, u))
                : this.client.core.relayer
                    .publish(n, t, u)
                    .catch((e) => this.client.logger.error(e)),
            ...
            (this.processRequestsQueue = async () => {
              if (this.requestQueue.state === r8.active) {
                this.client.logger.info(
              ...
              for (
                ...
                this.requestQueue.state = r8.active;
              ...
              this.requestQueue.state = r8.idle;
            }),
            (this.processRequest = (e) => {
              let { topic: t, payload: r } = e,
                i = r.method;
            ...
            (this.onSessionProposeRequest = async (e, t) => {
              let { params: r, id: i } = t;
              try {
                this.isValidConnect(ic({}, t.params));
                let n =
                    r.expiryTimestamp ||
                    (0, o.gn4)(r6.wc_sessionPropose.req.ttl),
                  s = ic({ id: i, pairingTopic: e, expiryTimestamp: n }, r);
            ...
            (this.onSessionSettleRequest = async (e, t) => {
              ...
              try {
                ...
                this.events.emit((0, o.E0T)("session_connect"), { session: l }),
            ...
            (this.onSessionSettleResponse = async (e, t) => {
              ...
              e5(t)
                ? (await this.client.session.update(e, { acknowledged: !0 }),
                  this.events.emit((0, o.E0T)("session_approve", r), {}))
                : e3(t) &&
                  (await this.client.session.delete(
                    e,
                    (0, o.D6H)("USER_DISCONNECTED")
            ...
            (this.onSessionUpdateRequest = async (e, t) => {
              ...
              try {
                ...
                this.isValidUpdate(ic({ topic: e }, r));
                try {
                  o.O6B.set(t, i),
            ...
            (this.onSessionExtendRequest = async (e, t) => {
              ...
              try {
                this.isValidExtend({ topic: e }),
                  await this.setExpiry(e, (0, o.gn4)(r3)),
                  await this.sendResult({
                    id: r,
                    topic: e,
                    result: !0,
            ...
            (this.onSessionExtendResponse = (e, t) => {
              let { id: r } = t,
                i = (0, o.E0T)("session_extend", r);
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              e5(t)
                ? this.events.emit((0, o.E0T)("session_extend", r), {})
                : e3(t) &&
                  this.events.emit((0, o.E0T)("session_extend", r), {
                    error: t.error,
                  });
            ...
            (this.onSessionPingResponse = (e, t) => {
              let { id: r } = t,
                i = (0, o.E0T)("session_ping", r);
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              setTimeout(() => {
                e5(t)
                  ? this.events.emit((0, o.E0T)("session_ping", r), {})
                  : e3(t) &&
                    this.events.emit((0, o.E0T)("session_ping", r), {
                      error: t.error,
                    });
            ...
            (this.onSessionDeleteRequest = async (e, t) => {
              ...
              try {
                this.isValidDisconnect({ topic: e, reason: t.params }),
                  await Promise.all([
                    new Promise((t) => {
                      this.client.core.relayer.once(t9.publish, async () => {
            ...
            (this.onSessionRequest = async (e, t) => {
              ...
              let { id: i, params: n } = t;
              try {
                await this.isValidRequest(ic({ topic: e }, n));
                let t = (0, o.rjm)(
                    JSON.stringify(eH("wc_sessionRequest", n, i))
                  ),
            ...
            (this.onSessionRequestResponse = (e, t) => {
              ...
              if (0 === this.events.listenerCount(i))
                throw Error(`emitting ${i} without any listeners`);
              e5(t)
                ? this.events.emit((0, o.E0T)("session_request", r), {
                    result: t.result,
                  })
                : e3(t) &&
                  this.events.emit((0, o.E0T)("session_request", r), {
                ...
                r
                  ...
                  .forEach((e) => {
                    ...
                    if (0 === this.events.listenerCount(i))
                      throw Error(`emitting ${i} without any listeners`);
                    this.events.emit(
                      (0, o.E0T)("session_request", e.request.id),
                      { error: t }
                    );
                  });
            }),
            (this.processSessionRequestQueue = () => {
              if (this.sessionRequestQueue.state === r8.active) {
                this.client.logger.info(
              ...
              try {
                (this.sessionRequestQueue.state = r8.active),
            ...
            (this.isValidConnect = async (e) => {
              ...
              if (
                ((0, o.o8e)(t) || (await this.isValidPairingTopic(t)),
                !(0, o.PMr)(s, !0))
              ) {
                let { message: e } = (0, o.kCb)(
                  "MISSING_OR_INVALID",
            ...
            (this.isValidApprove = async (e) => {
              if (!(0, o.EJd)(e))
                throw Error(
                  (0, o.kCb)("MISSING_OR_INVALID", `approve() params: ${e}`)
                    .message
                );
              let {
                id: t,
            ...
            (this.isValidRequest = async (e) => {
              ...
              if (n && !(0, o.ONw)(n, r2)) {
                let { message: e } = (0, o.kCb)(
                  "MISSING_OR_INVALID",
                  `request() expiry: ${n}. Expiry must be a number (in seconds) between ${r2.min} and ${r2.max}`
                );
                throw Error(e);
              }
            }),
            ...
            (this.isValidAuthenticate = (e) => {
              ...
              if (
                [...new Set(t.map((e) => (0, o.DQe)(e).namespace))].length > 1
              )
                throw Error(
                  "Multi-namespace requests are not supported. Please request single namespace only."
                );
              let { namespace: s } = (0, o.DQe)(t[0]);
              if ("eip155" !== s)
                throw Error(
        ...
        registerRelayerEvents() {
          this.client.core.relayer.on(t9.message, async (e) => {
            let { topic: t, message: r } = e,
              { publicKey: i } = this.client.auth.authKeys.keys.includes(r7)
                ? this.client.auth.authKeys.get(r7)
        ...
        registerExpirerEvents() {
          this.client.core.expirer.on(ro.expired, async (e) => {
            let { topic: t, id: r } = (0, o.iPz)(e.target);
        ...
        registerPairingEvents() {
          this.client.core.pairing.events.on(rn.create, (e) =>
            this.onPairingCreated(e)
          ),
            this.client.core.pairing.events.on(rn.delete, (e) => {
        ...
        async isValidProposalId(e) {
          ...
          if ((0, o.BwD)(this.client.proposal.get(e).expiryTimestamp)) {
            ...
            let { message: t } = (0, o.kCb)("EXPIRED", `proposal id: ${e}`);
            throw Error(t);
          }
        }
      }
      class il extends rq {
        constructor(e, t) {
          super(e, t, "proposal", rZ), (this.core = e), (this.logger = t);
        }
      }
      class ip extends rq {
        constructor(e, t) {
          super(e, t, "session", rZ), (this.core = e), (this.logger = t);
        }
      }
      class id extends rq {
        constructor(e, t) {
          super(e, t, "request", rZ, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      ...
      class iy extends rq {
        constructor(e, t) {
          super(e, t, "pairingTopics", r9), (this.core = e), (this.logger = t);
        }
      }
      class iv extends rq {
        constructor(e, t) {
          super(e, t, "requests", r9, (e) => e.id),
            (this.core = e),
            (this.logger = t);
        }
      }
      class im {
        constructor(e, t) {
          (this.core = e),
            (this.logger = t),
            (this.authKeys = new ig(this.core, this.logger)),
            (this.pairingTopics = new iy(this.core, this.logger)),
            (this.requests = new iv(this.core, this.logger));
        }
        async init() {
      ...
      class ib extends e_ {
        constructor(e) {
          super(e),
            ...
            (this.name = e?.name || r0.name),
            (this.metadata = e?.metadata || (0, o.DaH)()),
            (this.signConfig = e?.signConfig);
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ? e.logger
              : V()(ec({ level: e?.logger || r0.logger }));
          (this.core = e?.core || new rQ(e)),
            (this.logger = eh(t, this.name)),
            (this.session = new ip(this.core, this.logger)),
            (this.proposal = new il(this.core, this.logger)),
            (this.pendingRequest = new id(this.core, this.logger)),
            (this.engine = new ih(this)),
            (this.auth = new im(this.core, this.logger));
        }
        static async init(e) {
          let t = new ib(e);
      ...
      var iw = r(96279),
        ...
        iA = (e, t) => {
          ...
          if (iS) for (var r of iS(t)) iC.call(t, r) && iO(e, r, t[r]);
          return e;
        },
        ix = (e, t) => iD(e, iI(t));
      let iR = {
      ...
      class iT {
        ...
        async send(e) {
          ...
          try {
            let t = O(e),
              r = await (
                await i_()(this.url, ix(iA({}, iR), { body: t }))
              ).json();
        ...
        async register(e = this.url) {
          ...
          try {
            if (!this.disableProviderPing) {
              let t = O({ id: 1, jsonrpc: "2.0", method: "test", params: [] });
              await i_()(e, ix(iA({}, iR), { body: t }));
            }
            this.onOpen();
          } catch (t) {
      ...
      let iN = "error",
        ...
        ij = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
      var iL =
          "u" > typeof globalThis
            ? globalThis
            : "u" > typeof window
       ...
       */ !(function (e, t) {
        (function () {
          ...
          var eX = {
            ...
            eZ = parseFloat,
            e0 = parseInt,
            e1 = "object" == typeof iL && iL && iL.Object === Object && iL,
            e5 =
            ...
            tW = (function e(t) {
              ...
              function rM(e, t, r, i) {
                ...
                r && (t = tf(t, tx(r))),
                  i
                    ? ((s = tl), (o = !1))
                    : t.length >= 200 && ((s = tT), (o = !1), (t = new rE(t)));
                e: for (; ++n < a; ) {
                  var h = e[n],
                    l = null == r ? h : r(h);
              ...
              function r5(e, t, i) {
                t = iN(t, e);
                var n = null == (e = nA(e, t)) ? e : e[nU(nQ(t))];
                    ...
                    ? (function (e, t, i, n, s, o) {
                        ...
                        if (!(1 & i)) {
                          var O = b && eT.call(e, "__wrapped__"),
                            A = I && eT.call(t, "__wrapped__");
                          if (O || A) {
                            var x = O ? e.value() : e,
                              R = A ? t.value() : t;
                            return o || (o = new rD()), s(x, R, i, n, o);
                          }
                        }
                        return (
                          !!C &&
              ...
              function r8(e) {
                return (
                  !(!sV(e) || (ek && ek in e)) && (sB(e) ? eU : eu).test(nq(e))
                );
              }
              function r4(e) {
              ...
              function ic(e, t, r, i) {
                var n = i ? t_ : tw,
                  ...
                  o = t.length,
                  a = e;
                for (e === t && (t = iB(t)), r && (a = tf(e, tx(r))); ++s < o; )
                  for (
              ...
              function iS(e, t) {
                return (
                  (t = iN(t, e)), null == (e = nA(e, t)) || delete e[nU(nQ(t))]
                );
              }
              function iP(e, t, r, i) {
                ...
                return function v() {
                  ...
                  return (
                    ...
                    c
                      ? (b = (function (e, t) {
                          for (
                            var i = e.length, n = t3(t.length, i), s = iB(e);
                            n--;
                ...
                if (
                    ...
                    ? ((v = e),
                      ...
                      (T = function e() {
                        for (
                          ...
                          i[n] = arguments[n];
                        var o =
                          t < 3 && i[0] !== s && i[t - 1] !== s ? [] : t$(i, s);
                        return (t -= o.length) < b
                          ? i8(v, m, iZ, e.placeholder, r, i, o, r, r, b - t)
                          : ts(
                              this && this !== e3 && this instanceof e ? w : v,
                              this,
                              i
                            );
                      }))
                      ...
                      (T = function e() {
                        for (
                          var t = -1,
                            ...
                            s = em(n + r),
                            o =
                              this && this !== e3 && this instanceof e ? P : _;
                          ++i < n;
                  ...
                  var v,
                    ...
                    T =
                      ...
                      function e() {
                        return (
                          this && this !== e3 && this instanceof e ? R : C
                        ).apply(x ? A : this, arguments);
                      });
                return nk((g ? ig : nR)(T, y), e, t);
              }
              function nt(e, t, i, n) {
                return e === r || (sR(e, eA[i]) && !eT.call(n, i)) ? t : e;
              }
...
`
              ...
              var n$ = ip(function (e, t) {
                  return sU(e) ? rM(e, rF(t, 1, sU, !0)) : [];
                }),
                nB = ip(function (e, t) {
                  var i = nQ(t);
                  return (
                    sU(i) && (i = r),
                    sU(e) ? rM(e, rF(t, 1, sU, !0), nl(i, 2)) : []
                  );
                }),
                nF = ip(function (e, t) {
                  var i = nQ(t);
                  return (
                    sU(i) && (i = r), sU(e) ? rM(e, rF(t, 1, sU, !0), r, i) : []
                  );
                });
              function nH(e, t, r) {
              ...
              var n4 = ip(function (e, t) {
                ...
                n7 = ip(function (e) {
                  var t = nQ(e);
                  return sU(t) && (t = r), iA(tu(e, sU), nl(t, 2));
                }),
                se = ip(function (e) {
                  var t = nQ(e);
                  return (
                    (t = "function" == typeof t ? t : r), iA(tu(e, sU), r, t)
                  );
                }),
                st = ip(n2),
                sr = ip(function (e) {
              ...
              var sT = i2(rX),
                ...
                sk = r3(
                  ...
                  : function (e) {
                      return (
                        sK(e) && eT.call(e, "callee") && !e1.call(e, "callee")
                      );
                    },
                sj = em.isArray,
                sL = e7
              ...
              function sY(e) {
                ...
                return (
                  "function" == typeof r && r instanceof r && eR.call(r) == eL
                );
              }
              var sJ = tr
                  ? tx(tr)
                      ...
                      o &&
                        (e.prototype[r] = function () {
                          ...
                          if (s || t) {
                            ...
                            return (
                              (r.__actions__ = iB(this.__actions__)).push({
                                func: i,
                                args: arguments,
                                thisArg: e,
                              }),
              ...
              return (
                ...
                (rd.sampleSize = function (e, t, i) {
                  return (
                    ...
                    (sj(e)
                      ? function (e, t) {
                          return nL(iB(e), rN(t, 0, e.length));
                        }
                      : function (e, t) {
                          var r = o_(e);
                ...
                (rd.toPath = function (e) {
                  return sj(e) ? tf(e, nU) : sZ(e) ? [e] : iB(nM(s7(e)));
                }),
                (rd.toPlainObject = s9),
                ...
                (rd.escape = function (e) {
                  return (e = s7(e)) && B.test(e) ? e.replace(z, tL) : e;
                }),
...
`) +
                ...
                (rd.toSafeInteger = function (e) {
                  return e
                    ? rN(s2(e), -9007199254740991, 9007199254740991)
                    : 0 === e
                    ? e
                    : 0;
                }),
      ...
      var iU = Object.defineProperty,
        ...
        iH = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        iV = (e, t) => {
          for (var r in t || (t = {})) iB.call(t, r) && iH(e, r, t[r]);
          if (i$) for (var r of i$(t)) iF.call(t, r) && iH(e, r, t[r]);
          return e;
        },
        iK = (e, t) => iq(e, iz(t));
      function iW(e, t, r) {
      ...
      function iQ(e) {
        ...
        for (let [a, c] of Object.entries(e)) {
          ...
          s[f] = iK(iV(iV({}, s[f]), c), {
            ...
            rpcMap: iV(iV({}, l), null == (n = s[f]) ? void 0 : n.rpcMap),
          });
        }
        return s;
      }
      ...
      function iZ(e) {
        ...
        for (let [r, i] of Object.entries(e)) {
          let e = i.methods || [],
            n = i.events || [],
            s = i.accounts || [],
            a = (0, o.gpE)(r) ? [r] : i.chains ? i.chains : iY(i.accounts);
      ...
      class i6 {
        constructor(e) {
          (this.name = "polkadot"),
            ...
            (this.events = i5("events")),
            (this.client = i5("client")),
        ...
        setDefaultChain(e, t) {
          this.httpProviders[e] || this.setHttpProvider(e, t),
            (this.chainId = e),
            this.events.emit(ij.DEFAULT_CHAIN_CHANGED, `${this.name}:${e}`);
        }
        getAccounts() {
        ...
        createHttpProvider(e, t) {
          let r = t || iW(e, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new e6(new iT(r, i5("disableProviderPing")));
        }
      }
      class i2 {
        constructor(e) {
        ...
        createHttpProvider(e, t) {
          let r =
            t ||
            iW(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new e6(new iT(r, i5("disableProviderPing")));
        }
        setHttpProvider(e, t) {
      ...
      class nt {
        ...
        setDefaultChain(e, t) {
          if (((this.chainId = e), !this.httpProviders[e])) {
            let r = t || iW(`${this.name}:${e}`, this.namespace);
            if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
        ...
        createHttpProvider(e, t) {
          let r = t || iW(e, this.namespace);
          return typeof r > "u"
            ? void 0
            : new e6(new iT(r, i5("disableProviderPing")));
        }
      }
      var nr = Object.defineProperty,
        ...
        nu = (e, t) => {
          ...
          if (ns) for (var r of ns(t)) na.call(t, r) && nc(e, r, t[r]);
          return e;
        },
        nh = (e, t) => ni(e, nn(t));
      class nl {
        ...
        async authenticate(e) {
          ...
          if (((this.session = i.session), this.session)) {
            let e = iZ(this.session.namespaces);
            (this.namespaces = iJ(this.namespaces, e)),
          ...
          do {
            ...
            r && ((this.uri = r), this.events.emit("display_uri", r)),
              await i()
                .then((e) => {
                  this.session = e;
                  let t = iZ(e.namespaces);
                  (this.namespaces = iJ(this.namespaces, t)),
                    this.persist("namespaces", this.namespaces);
                })
                .catch((e) => {
                  if (e.message !== r5) throw e;
                  t++;
                });
          } while (!this.session);
        ...
        async createClient() {
          (this.client =
            ...
            (await ib.init({
              logger: this.providerOpts.logger || iN,
              relayUrl:
        ...
        createProviders() {
          ...
          let e = [
            ...new Set(
              Object.keys(this.session.namespaces).map((e) => (0, o.Maj)(e))
            ),
          ];
          i3("client", this.client),
            i3("events", this.events),
            i3("disableProviderPing", this.disableProviderPing),
            e.forEach((e) => {
              if (!this.session) return;
              let t = (function (e, t) {
                ...
                r = iY(t),
                i = nh(
                  nu({}, iJ(this.namespaces, this.optionalNamespaces)[e]),
                  { accounts: t, chains: r }
                );
              switch (e) {
                case "eip155":
                  this.rpcProviders[e] = new i2({ namespace: i });
                  break;
                case "solana":
                  this.rpcProviders[e] = new i8({ namespace: i });
                  break;
                case "cosmos":
                  this.rpcProviders[e] = new i4({ namespace: i });
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new i6({ namespace: i });
                  break;
                case "cip34":
                  this.rpcProviders[e] = new i9({ namespace: i });
                  break;
                case "elrond":
                  this.rpcProviders[e] = new i7({ namespace: i });
                  break;
                case "multiversx":
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === r.name) {
                ...
                e &&
                  (0, o.qt8)(e) &&
                  this.events.emit("accountsChanged", e.map(iX));
              } else if ("chainChanged" === r.name) {
                let e = t.chainId,
                  r = t.event.data,
                  i = (0, o.Maj)(e),
                  n = i0(e) !== i0(r) ? `${i}:${i0(r)}` : e;
            ...
            this.client.on("session_update", ({ topic: e, params: t }) => {
              ...
              (this.session = nh(nu({}, n), { namespaces: i })),
            ...
            this.client.on("session_delete", async (e) => {
              await this.cleanup(),
                ...
                this.events.emit(
                  "disconnect",
                  nh(nu({}, (0, o.D6H)("USER_DISCONNECTED")), { data: e.topic })
                );
            }),
            this.on(ij.DEFAULT_CHAIN_CHANGED, (e) => {
      ...
      let nf = ["eth_sendTransaction", "personal_sign"],
        np = [
          "eth_accounts",
          "eth_requestAccounts",
        ...
        nd = ["chainChanged", "accountsChanged"],
        ng = [
          "chainChanged",
          "accountsChanged",
          "message",
      ...
      var ny = Object.defineProperty,
        ...
        nE = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        nD = (e, t) => {
          for (var r in t || (t = {})) nw.call(t, r) && nE(e, r, t[r]);
          if (nb) for (var r of nb(t)) n_.call(t, r) && nE(e, r, t[r]);
          return e;
        },
        nI = (e, t) => nv(e, nm(t));
      function nS(e) {
      ...
      class nC {
        ...
        async connect(e) {
          ...
          let { required: t, optional: r } = (function (e) {
            ...
            let u = {
                ...
                methods: i || nf,
                events: s || nd,
                rpcMap: nD({}, t.length ? { [nS(t)]: c[nS(t)] } : {}),
              },
              h = s?.filter((e) => !nd.includes(e)),
              l = i?.filter((e) => !nf.includes(e));
            if (
              !r &&
              !a &&
              !n &&
            ...
            let f = (h?.length && l?.length) || !r,
              p = {
                chains: [...new Set(f ? u.chains.concat(r || []) : r)],
                methods: [
                  ...new Set(u.methods.concat(null != n && n.length ? n : np)),
                ],
                events: [
                  ...new Set(u.events.concat(null != a && a.length ? a : ng)),
                ],
                rpcMap: c,
              };
            return {
          ...
          try {
              ...
              this.rpc.showQrModal &&
                ...
                await this.signer
                  .connect(
                    nI(
                      nD(
                        { namespaces: nD({}, t && { [this.namespace]: t }) },
            ...
            this.setChainIds(this.rpc.chains.length ? this.rpc.chains : n),
              this.setAccounts(n),
              this.events.emit("connect", { chainId: nP(this.chainId) });
          } catch (e) {
          ...
          try {
            let t = await new Promise(async (t, r) => {
                ...
                this.rpc.showQrModal &&
                  ...
                  await this.signer
                    .authenticate(nI(nD({}, e), { chains: this.rpc.chains }))
                    .then((e) => {
                      t(e);
                    })
                    .catch((e) => {
        ...
        registerEventListeners() {
          this.signer.on("session_event", (e) => {
            ...
            this.signer.on("chainChanged", (e) => {
              let t = parseInt(e);
              (this.chainId = t),
                this.events.emit("chainChanged", nP(this.chainId)),
                this.persist();
            }),
            ...
            this.signer.on("session_delete", (e) => {
              this.reset(),
                ...
                this.events.emit(
                  "disconnect",
                  nI(nD({}, (0, o.D6H)("USER_DISCONNECTED")), {
                    data: e.topic,
        ...
        getRpcConfig(e) {
          ...
          let o = i.length ? e?.methods || nf : [],
            a = i.length ? e?.events || nd : [],
            c = e?.optionalMethods || [],
            u = e?.optionalEvents || [],
        ...
        async initialize(e) {
          if (
            ...
            (this.chainId = this.rpc.chains.length
              ? nS(this.rpc.chains)
              : nS(this.rpc.optionalChains)),
            (this.signer = await nl.init({
            ...
            if (e)
              try {
                this.modal = new e(
                  nD({ projectId: this.rpc.projectId }, this.rpc.qrModalOptions)
                );
              } catch (e) {
                throw (
    ...
    16362: function (e, t, r) {
      ...
      let C = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new P(e, t, r, i),
        O = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: n } = v(r, t);
          return C({ prefix: e, name: t, encode: i, decode: (e) => b(n(e)) });
        },
        A = (e, t, r, i) => {
          let n = {};
          for (let e = 0; e < t.length; ++e) n[t[e]] = e;
        ...
        j = O({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        L = R({
          prefix: "f",
          name: "base16",
          alphabet: "0123456789abcdef",
      ...
      let eo = (e, t = 0) => [es.decode(e, t), es.decode.bytes],
      ...
      let eg = (e) => async (t) =>
        ...
        eS = "json",
        eP = 512,
        eC = (e) => eD.encode(JSON.stringify(e)),
      ...
      class eA {
        ...
        toString(e) {
          ...
          return 0 === r ? eR(t, i, e || Y.encoder) : eT(t, i, e || U.encoder);
        }
        toJSON() {
          return {
            code: this.code,
        ...
        static isCID(e) {
          return eq(/^0\.0/, ez), !!(e && (e[eL] || e.asCID === e));
        }
        ...
        static asCID(e) {
          ...
          if (null != e && e.asCID === e) {
            ...
            return new eA(t, r, i, n || ej(t, r, i.bytes));
          }
        ...
        static create(e, t, r) {
          ...
          switch (e) {
            case 0:
              if (t === eN) return new eA(e, t, r, r.bytes);
              throw Error(
        ...
        static decodeFirst(e) {
          ...
          return [
            0 === t.version ? eA.createV0(s) : eA.createV1(t.codec, s),
            e.subarray(t.size),
          ];
        }
