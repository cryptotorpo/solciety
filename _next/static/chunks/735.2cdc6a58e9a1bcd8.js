  ...
  [735],
  {
              ...
              onChainUpdate: ({ chain: e, source: t }) => {
                (e.id !== this.chain.id || e.rpcUrl !== this.chain.rpcUrl) &&
                  ...
                  "storage" !== t &&
                    this.emit(
                      "chainChanged",
                      (0, c.hexStringFromIntNumber)((0, d.IntNumber)(e.id))
                    ));
              },
            }),
            (this.metadata = n),
            (this.preference = p),
            (this.communicator = new u.Communicator(o)),
            (this.chain = {
              id:
                null !==
                  (r =
                    null === (t = n.appChainIds) || void 0 === t
                      ? void 0
                      : t[0]) && void 0 !== r
                  ? r
                  : 1,
    ...
    19466: function (e, t, r) {
      ...
      class c {
        ...
        makeWeb3Provider(e = { options: "all" }) {
          ...
          return null !== (t = (0, d.getCoinbaseInjectedProvider)(r)) &&
            void 0 !== t
            ? t
            : new n.CoinbaseWalletProvider(r);
        }
          ...
          (this.popup = null),
            ...
            (this.waitForPopupLoaded = async () =>
              this.popup && !this.popup.closed
                ...
                : ((this.popup = (0, n.openPopup)(this.url)),
    ...
    92669: function (e, t, r) {
      ...
      t.standardErrors = {
        rpc: {
          ...
          resourceNotFound: (e) =>
            i(s.standardErrorCodes.rpc.resourceNotFound, e),
          resourceUnavailable: (e) =>
            i(s.standardErrorCodes.rpc.resourceUnavailable, e),
          transactionRejected: (e) =>
            i(s.standardErrorCodes.rpc.transactionRejected, e),
          methodNotSupported: (e) =>
            i(s.standardErrorCodes.rpc.methodNotSupported, e),
    ...
    43294: function (e, t, r) {
      ...
      t.serializeError = function (e, t) {
        ...
        o.searchParams.set("version", n.LIB_VERSION),
          ...
          return (
            ...
            a(e.code)
              ...
              : ((r.code = s.standardErrorCodes.rpc.internal),
                (r.message = c(e, "message") ? e.message : n),
                (r.data = { originalError: o(e) })),
    ...
    20735: function (e, t, r) {
      "use strict";
      let s = r(19466);
      (t.default = s.CoinbaseWalletSDK), r(19466);
    },
    8317: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      class d {
        constructor() {
          (this.storage = new n.ScopedLocalStorage("CBWSDK", "SCWKeyManager")),
        ...
        async loadKeysIfNeeded() {
          null === this.ownPrivateKey &&
            ...
            null === this.sharedSecret &&
              null !== this.ownPrivateKey &&
              null !== this.peerPublicKey &&
              (this.sharedSecret = await (0, s.deriveSharedSecret)(
                this.ownPrivateKey,
                this.peerPublicKey
              ));
        }
    ...
    24745: function (e, t, r) {
      ...
      class d {
        ...
        updateInternalState(e, t) {
          ...
          let i =
            null === (s = t.data) || void 0 === s ? void 0 : s.capabilities;
    ...
    3182: function (e, t, r) {
      ...
      async function l(e) {
        ...
        let s = {
          ...
          { data: n } = await t.postRequestAndWaitForResponse(s);
        return n;
      }
      async function h(e, t) {
        await e.onMessage(({ event: e }) => "WalletLinkSessionRequest" === e);
        let r = new n.WalletLinkSigner({ metadata: t });
        e.postMessage({
      ...
      (t.loadSignerType = function () {
        ...
        (t.createSigner = function (e) {
          ...
          switch (t) {
            ...
            case "walletlink":
              return new n.WalletLinkSigner({ metadata: r, updateListener: d });
            case "extension": {
    ...
    30133: function (e, t, r) {
      ...
      class f {
        constructor(e) {
          ...
          let { appName: s, appLogoUrl: n } = e.metadata;
          (this._appName = s),
            (this._appLogoUrl = n),
        ...
        async switchEthereumChain(e) {
          ...
          s.isApproved &&
            s.rpcUrl.length > 0 &&
            this.updateProviderInfo(s.rpcUrl, e);
        }
        async disconnect() {
        ...
        async _eth_signTypedData_v1(e) {
          ...
          let s = i.default.hashForSignTypedDataLegacy({ data: t }),
        ...
        async _eth_signTypedData_v3(e) {
          ...
          this._ensureKnownAddress(t);
          let s = i.default.hashForSignTypedData_v3({ data: r }),
        ...
        async _eth_signTypedData_v4(e) {
          ...
          let t = (0, u.ensureAddressString)(e[0]),
            r = (0, u.ensureParsedJSONObject)(e[1]);
          this._ensureKnownAddress(t);
          let s = i.default.hashForSignTypedData_v4({ data: r }),
            n = JSON.stringify(r, null, 2);
          return this._signEthereumMessage(s, t, !1, n);
        }
        async _wallet_addEthereumChain(e) {
          ...
          return (await this.addEthereumChain(
            ...
            null !== (s = i.blockExplorerUrls) && void 0 !== s ? s : [],
            i.chainName,
            null !== (n = i.iconUrls) && void 0 !== n ? n : [],
            i.nativeCurrency
          ))
        ...
        async _wallet_watchAsset(e) {
          ...
          let r = this.getChainId(),
            { address: s, symbol: n, image: i, decimals: a } = t.options;
          return {
            jsonrpc: "2.0",
            id: 0,
            result: await this.watchAsset(t.type, s, n, a, i, r),
          };
        }
        initializeRelay() {
          if (!this._relay) {
      ...
      class g {
        constructor(e) {
          (this.accountsCallback = null),
            ...
            (this.isMobileWeb = (0, d.isMobileWeb)()),
            (this.appName = ""),
          ...
          return this.sendRequest({
            ...
            params: {
              ...
              gasPriceInWei: e.gasPriceInWei
                ? (0, u.bigIntStringFromBigInt)(e.gasPriceInWei)
                : null,
              ...
              maxPriorityFeePerGas: e.gasPriceInWei
                ...
                : null,
              gasLimit: e.gasLimit
                ? (0, u.bigIntStringFromBigInt)(e.gasLimit)
                : null,
              chainId: e.chainId,
              shouldSubmit: !1,
            },
          ...
          return this.sendRequest({
            ...
            params: {
              ...
              maxFeePerGas: e.maxFeePerGas
                ? (0, u.bigIntStringFromBigInt)(e.maxFeePerGas)
                : null,
              maxPriorityFeePerGas: e.maxPriorityFeePerGas
                ? (0, u.bigIntStringFromBigInt)(e.maxPriorityFeePerGas)
                : null,
              gasLimit: e.gasLimit
                ? (0, u.bigIntStringFromBigInt)(e.gasLimit)
                : null,
        ...
        openCoinbaseWalletDeeplink(e) {
          if (this.ui instanceof l.WLMobileRelayUI)
            switch (e) {
        ...
        handleErrorResponse(e, t, r) {
          ...
          this.handleWeb3ResponseMessage({
            type: "WEB3_RESPONSE",
            id: e,
            response: { method: t, errorMessage: n },
          });
        }
        invokeCallback(e) {
        ...
        watchAsset(e, t, r, s, n, i) {
          let a = {
              ...
              params: {
                type: e,
                options: { address: t, symbol: r, decimals: s, image: n },
                chainId: i,
              },
            },
            d = null,
          ...
          return (
            ...
            new Promise((e, t) => {
              this.relayEventManager.callbacks.set(c, (r) => {
                if ((null == d || d(), (0, o.isErrorResponse)(r)))
      ...
      class d {
        constructor({
          ...
          (this.destroyed = !1),
            ...
            (this.session = e),
            (this.cipher = new n.WalletLinkCipher(e.secret)),
            (this.listener = r);
    ...
    16673: function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        ((s = r || (t.ConnectionState = r = {}))[(s.DISCONNECTED = 0)] =
          "DISCONNECTED"),
    ...
    6288: function (e, t, r) {
      ...
      class d {
        constructor(e, t, r, i) {
          (this._storage = e),
            (this._id = t || (0, n.randomBytesHex)(16)),
            (this._secret = r || (0, n.randomBytesHex)(32)),
            (this._key = new s.sha256()
    ...
    76768: function (e, t, r) {
      ...
      class a {
        ...
        redirectToCoinbaseWallet(e) {
          ...
          t.searchParams.append("redirect_url", (0, n.getLocation)().href),
    ...
    98718: function (e, t, r) {
      ...
      t.injectCssReset = function () {
        ...
        (e.type = "text/css"),
          e.appendChild(document.createTextNode(n.default)),
    ...
    68482: function (e, t) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.createQrUrl = function (e, t, r, s, n, i) {
    ...
    8454: function (e, t, r) {
      ...
      async function i(e, t) {
        if (!t.rpcUrl)
          throw n.standardErrors.rpc.internal("No RPC URL set for chain");
      ...
      (t.fetchRPCRequest = i),
        ...
        (t.getCoinbaseInjectedProvider = function ({
          ...
          if ("smartWalletOnly" !== t.options) {
            ...
            if (t) {
              let { appName: s, appLogoUrl: n, appChainIds: i } = e;
              return (
                null === (r = t.setAppInfo) ||
                  void 0 === r ||
                  r.call(t, s, n, i),
        ...
        (t.checkErrorForInvalidRequestArgs = function (e) {
          if (!e || "object" != typeof e || Array.isArray(e))
            return n.standardErrors.rpc.invalidParams({
              message: "Expected a single, non-array, object argument.",
              data: e,
            });
          let { method: t, params: r } = e;
          return "string" != typeof t || 0 === t.length
            ? n.standardErrors.rpc.invalidParams({
                message: "'args.method' must be a non-empty string.",
                data: e,
              })
            : void 0 === r ||
    ...
    78253: function (e, t, r) {
      ...
      function l(e, t) {
        ...
        if ((p = e).lastIndexOf("]") === p.length - 1) {
          ...
          if ("dynamic" !== (r = d(e)) && 0 !== r && t.length > r)
        ...
        if ("bytes" === e)
          return (
            (t = new s(t)),
            (h = s.concat([l("uint256", t.length), t])),
            t.length % 32 != 0 &&
              (h = s.concat([h, n.zeros(32 - (t.length % 32))])),
            h
          );
        if (e.startsWith("bytes")) {
          ...
          return (r = o(e)), l("int256", c(t) * BigInt(2) ** BigInt(r[1]));
      ...
      e.exports = {
        rawEncode: function (e, t) {
          ...
          for (var o in e) {
            var c = i(e[o]),
              h = l(c, t[o]);
            "string" === c || "bytes" === c || "dynamic" === d(c)
              ? (r.push(l("uint256", a)), n.push(h), (a += h.length))
              : r.push(h);
          }
        ...
        o = {
          encodeData(e, t, r, a = !0) {
            ...
            if (a) {
                ...
                if (void 0 !== r[t])
                  return [
                    ...
                    null == o
                      ...
                      : n.keccak(this.encodeData(t, o, r, a)),
                  ];
                if (void 0 === o)
              ...
              for (let i of r[e]) {
                ...
                if (void 0 !== e) {
                  if ("bytes" === i.type)
                    o.push("bytes32"), (e = n.keccak(e)), d.push(e);
                    ...
                    o.push("bytes32"),
                      (e = n.keccak(this.encodeData(i.type, e, r, a))),
                      d.push(e);
          ...
          encodeType(e, t) {
            ...
            for (let n of (s = [e].concat(s.sort()))) {
              if (!t[n]) throw Error("No type definition specified: " + n);
              r +=
                n +
                "(" +
                t[n].map(({ name: e, type: t }) => t + " " + e).join(",") +
                ")";
            }
            return r;
          },
      ...
      function d(e) {
        if (!s.isBuffer(e)) {
          if (Array.isArray(e)) e = s.from(e);
            ...
            var t;
            e = c(e)
              ? s.from((t = l(e)).length % 2 ? "0" + t : t, "hex")
              : s.from(e);
