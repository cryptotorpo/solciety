...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7064],
  {
    35192: function (t, e, r) {
      ...
      var k = Object.defineProperty,
        ...
        D = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        F = (t, e) => {
          for (var r in e || (e = {})) U.call(e, r) && D(t, r, e[r]);
          if (P) for (var r of P(e)) T.call(e, r) && D(t, r, e[r]);
          return t;
        };
      let L = {
      ...
      function j() {
        return !q() && !!(0, A.getNavigator)() && !!(0, A.getDocument)();
      }
      function H() {
        return z() ? L.reactNative : q() ? L.node : j() ? L.browser : L.unknown;
      }
      function K() {
        var t;
        try {
      ...
      async function ts({ id: t, topic: e, wcDeepLink: i }) {
        try {
          if (!i) return;
      ...
      async function tu(t, e) {
        try {
          return (
            (await t.getItem(e)) || (j() ? localStorage.getItem(e) : void 0)
          );
        } catch (t) {
          console.error(t);
        }
      ...
      !(function () {
        ...
        C.versions.node
          ? (r = tf)
          : i && (r = self);
        var n = !r.JS_SHA3_NO_COMMON_JS && th.exports,
        ...
        for (
          var p = function (t, e, r) {
              return function (i) {
                return new x(t, e, t).update(i)[r]();
              };
            },
            m = function (t, e, r) {
              return function (i, n) {
                return new x(t, e, n).update(i)[r]();
              };
            },
            g = function (t, e, r) {
        ...
        (x.prototype.update = function (e) {
          ...
          (x.prototype.encodeString = function (e) {
            var r,
              i = typeof e;
            if ("string" !== i) {
              if ("object" === i) {
          ...
          (x.prototype.bytepad = function (t, e) {
      ...
      let tl = !1,
        tc = !1,
        td = { debug: 1, default: 2, info: 2, warning: 3, error: 4, off: 5 },
        tp = 2,
        tm = null,
        tg = (function () {
          try {
      ...
      class tA {
        ...
        _log(t, e) {
          ...
          null == td[r] &&
            ...
            tp > td[r] || console.log.apply(console, e);
        }
        debug(...t) {
        ...
        checkNormalize(t) {
          tg &&
            this.throwError(
              ...
              { operation: "String.prototype.normalize", form: tg }
            );
        }
        checkSafeUint53(t, e) {
          "number" == typeof t &&
        ...
        static globalLogger() {
          return tm || (tm = new tA("logger/5.7.0")), tm;
        }
      ...
      (tA.errors = c), (tA.levels = l);
      let ty = new tA("bytes/5.7.0");
      function tb(t) {
        ...
        return (
          t.slice ||
            (t.slice = function () {
              ...
              return tw(new Uint8Array(Array.prototype.slice.apply(t, e)));
            }),
          t
        );
      }
      ...
      function tE(t) {
        ...
        if ("string" == typeof t || !tM(t.length) || t.length < 0) return !1;
        for (let e = 0; e < t.length; e++) {
          let r = t[e];
          if (!tM(r) || r < 0 || r >= 256) return !1;
        }
        return !0;
      }
      function tS(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          ty.checkSafeUint53(t, "invalid arrayify value");
          let e = [];
          for (; t; ) e.unshift(255 & t), (t = parseInt(String(t / 256)));
          return 0 === e.length && e.push(0), tw(new Uint8Array(e));
        }
        if (
          ...
          r.length % 2 &&
            ("left" === e.hexPad
              ...
              : "right" === e.hexPad
              ? (r += "0")
              : ty.throwArgumentError("hex data is odd-length", "value", t));
          let i = [];
          for (let t = 0; t < r.length; t += 2)
            i.push(parseInt(r.substring(t, t + 2), 16));
          return tw(new Uint8Array(i));
        }
        return tE(t)
          ? tw(new Uint8Array(t))
          : ty.throwArgumentError("invalid arrayify value", "value", t);
      }
      function tI(t, e) {
        return !(
          "string" != typeof t ||
      ...
      let tN = "0123456789abcdef";
      function tB(t, e) {
        if ((e || (e = {}), "number" == typeof t)) {
          ty.checkSafeUint53(t, "invalid hexlify value");
          let e = "";
          for (; t; ) (e = tN[15 & t] + e), (t = Math.floor(t / 16));
        ...
        if (tE(t)) {
          ...
          for (let r = 0; r < t.length; r++) {
            let i = t[r];
            e += tN[(240 & i) >> 4] + tN[15 & i];
          }
          return e;
        }
        return ty.throwArgumentError("invalid hexlify value", "value", t);
      }
      function tC(t, e, r) {
        return (
          "string" != typeof t
            ? (t = tB(t))
            : (!tI(t) || t.length % 2) &&
              ty.throwArgumentError("invalid hexData", "value", t),
          (e = 2 + 2 * e),
      ...
      function t_(t, e) {
        for (
          "string" != typeof t
            ? (t = tB(t))
            : tI(t) || ty.throwArgumentError("invalid hex string", "value", t),
            t.length > 2 * e + 2 &&
        ...
        if ((tI(t) && !(t.length % 2)) || tE(t)) {
          ...
          64 === r.length
            ...
            ? ((e.r = tB(r.slice(0, 32))),
              (e.s = tB(r.slice(32, 64))),
              (e.v = r[64]))
            : ty.throwArgumentError("invalid signature string", "signature", t),
            e.v < 27 &&
              (0 === e.v || 1 === e.v
                ? (e.v += 27)
                : ty.throwArgumentError(
          ...
          if (
            ...
            let r = (function (t, e) {
              ...
              return r.set(t, e - t.length), tw(r);
            })(tS(e._vs), 32);
            e._vs = tB(r);
            let i = r[0] >= 128 ? 1 : 0;
          ...
          let r = tS(e.s);
          r[0] >= 128 &&
            ty.throwArgumentError("signature s out of range", "signature", t),
            e.recoveryParam && (r[0] |= 128);
          let i = tB(r);
          e._vs &&
            (tI(e._vs) ||
              ty.throwArgumentError("signature invalid _vs", "signature", t),
            (e._vs = t_(e._vs, 32))),
            null == e._vs
              ? (e._vs = i)
              : e._vs !== i &&
      ...
      !(function (t, e) {
        ...
        var m = function (t, e, r) {
          ...
          (h = (((o + (n >>> 13)) | 0) + (tw >>> 26)) | 0),
            (tw &= 67108863),
            (i = Math.imul(_, z)),
            (n = ((n = Math.imul(_, j)) + Math.imul(x, z)) | 0),
            (o = Math.imul(x, j)),
            (i = (i + Math.imul(N, K)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tM >>> 26)) | 0),
            ...
            (o = Math.imul(k, j)),
            (i = (i + Math.imul(_, K)) | 0),
            (n = ((n = (n + Math.imul(_, Q)) | 0) + Math.imul(x, K)) | 0),
            (o = (o + Math.imul(x, Q)) | 0),
            (i = (i + Math.imul(N, G)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tE >>> 26)) | 0),
            ...
            (o = (o + Math.imul(k, Q)) | 0),
            (i = (i + Math.imul(_, G)) | 0),
            (n = ((n = (n + Math.imul(_, Y)) | 0) + Math.imul(x, G)) | 0),
            (o = (o + Math.imul(x, Y)) | 0),
            (i = (i + Math.imul(N, W)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tS >>> 26)) | 0),
            ...
            (o = (o + Math.imul(k, Y)) | 0),
            (i = (i + Math.imul(_, W)) | 0),
            (n = ((n = (n + Math.imul(_, X)) | 0) + Math.imul(x, W)) | 0),
            (o = (o + Math.imul(x, X)) | 0),
            (i = (i + Math.imul(N, $)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tI >>> 26)) | 0),
            ...
            (o = (o + Math.imul(k, X)) | 0),
            (i = (i + Math.imul(_, $)) | 0),
            (n = ((n = (n + Math.imul(_, tt)) | 0) + Math.imul(x, $)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tN >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(_, ti)) | 0) + Math.imul(x, tr)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tB >>> 26)) | 0),
            ...
            (i = (i + Math.imul(_, to)) | 0),
            (n = ((n = (n + Math.imul(_, ts)) | 0) + Math.imul(x, to)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tC >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(_, th)) | 0) + Math.imul(x, tf)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (t_ >>> 26)) | 0),
            ...
            (i = (i + Math.imul(_, tl)) | 0),
            (n = ((n = (n + Math.imul(_, tc)) | 0) + Math.imul(x, tl)) | 0),
          ...
          (h = (((o + (n >>> 13)) | 0) + (tx >>> 26)) | 0),
            ...
            (n = ((n = (n + Math.imul(_, tm)) | 0) + Math.imul(x, tp)) | 0),
      ...
      class tq {
        ...
        fromTwos(t) {
          return tj(tH(this).fromTwos(t));
        }
        toTwos(t) {
          return tj(tH(this).toTwos(t));
        }
        abs() {
          return "-" === this._hex[0] ? tq.from(this._hex.substring(1)) : this;
        }
        add(t) {
          return tj(tH(this).add(tH(t)));
        }
        sub(t) {
          return tj(tH(this).sub(tH(t)));
        }
        div(t) {
          return (
            tq.from(t).isZero() && tK("division-by-zero", "div"),
            tj(tH(this).div(tH(t)))
          );
        }
        mul(t) {
          return tj(tH(this).mul(tH(t)));
        }
        mod(t) {
          let e = tH(t);
          return (
            e.isNeg() && tK("division-by-zero", "mod"), tj(tH(this).umod(e))
          );
        }
        pow(t) {
          let e = tH(t);
          return e.isNeg() && tK("negative-power", "pow"), tj(tH(this).pow(e));
        }
        and(t) {
          let e = tH(t);
          return (
            (this.isNegative() || e.isNeg()) &&
              tK("unbound-bitwise-result", "and"),
            tj(tH(this).and(e))
          );
        }
        or(t) {
        ...
        xor(t) {
          ...
          return (
            (this.isNegative() || e.isNeg()) &&
              tK("unbound-bitwise-result", "xor"),
            tj(tH(this).xor(e))
          );
        }
        mask(t) {
          return (
            (this.isNegative() || t < 0) && tK("negative-width", "mask"),
            tj(tH(this).maskn(t))
          );
        }
        shl(t) {
          return (
            (this.isNegative() || t < 0) && tK("negative-width", "shl"),
            tj(tH(this).shln(t))
          );
        }
        shr(t) {
          return (
            (this.isNegative() || t < 0) && tK("negative-width", "shr"),
            tj(tH(this).shrn(t))
          );
        }
        eq(t) {
          return tH(this).eq(tH(t));
        }
        lt(t) {
          return tH(this).lt(tH(t));
        }
        lte(t) {
          return tH(this).lte(tH(t));
        }
        gt(t) {
          return tH(this).gt(tH(t));
        }
        gte(t) {
          return tH(this).gte(tH(t));
        }
        isNegative() {
          return "-" === this._hex[0];
        }
        isZero() {
          return tH(this).isZero();
        }
        toNumber() {
          try {
            return tH(this).toNumber();
          } catch {
            tK("overflow", "toNumber", this.toString());
          }
          return null;
        }
        toBigInt() {
        ...
        static from(t) {
          ...
          if ("string" == typeof t)
            return t.match(/^-?0x[0-9a-f]+$/i)
              ? new tq(tF, tz(t))
              : t.match(/^-?[0-9]+$/)
              ? new tq(tF, tz(new tT(t)))
              : tD.throwArgumentError("invalid BigNumber string", "value", t);
          if ("number" == typeof t)
            return (
              t % 1 && tK("underflow", "BigNumber.from", t),
              (t >= 9007199254740991 || t <= -9007199254740991) &&
                tK("overflow", "BigNumber.from", t),
              tq.from(String(t))
            );
          if ("bigint" == typeof t) return tq.from(t.toString());
          if (tE(t)) return tq.from(tB(t));
          if (t) {
            if (t.toHexString) {
              let e = t.toHexString();
              ...
              if (
                ...
                "string" == typeof e &&
                  (tI(e) || ("-" === e[0] && tI(e.substring(1)))))
              )
                return tq.from(e);
            }
          }
          return tD.throwArgumentError("invalid BigNumber value", "value", t);
        }
      ...
      function tz(t) {
        if ("string" != typeof t) return tz(t.toString(16));
        if ("-" === t[0])
          return (
            "-" === (t = t.substring(1))[0] &&
              tD.throwArgumentError("invalid hex", "value", t),
            "0x00" === (t = tz(t)) ? t : "-" + t
          );
      ...
      function tH(t) {
        ...
        return "-" === e[0]
          ? new tT("-" + e.substring(3), 16)
          : new tT(e.substring(2), 16);
      }
      function tK(t, e, r) {
        let i = { fault: t, operation: e };
        return (
          null != r && (i.value = r),
          tD.throwError(t, tA.errors.NUMERIC_FAULT, i)
        );
      }
      let tQ = new tA(tU),
        tJ = {},
      ...
      function tV(t, e, r, i) {
        ...
        return (
          void 0 !== i && (n.value = i),
          tQ.throwError(t, tA.errors.NUMERIC_FAULT, n)
        );
      }
      let tW = "0";
      for (; tW.length < 256; ) tW += tW;
      function tX(t) {
        if ("number" != typeof t)
          try {
        ...
        return "number" == typeof t && t >= 0 && t <= 256 && !(t % 1)
          ? "1" + tW.substring(0, t)
          : tQ.throwArgumentError("invalid decimal size", "decimals", t);
      }
      function tZ(t, e) {
        null == e && (e = 0);
        let r = tX(e),
      ...
      function t$(t, e) {
        ...
        ("string" == typeof t && t.match(/^-?[0-9.]+$/)) ||
          tQ.throwArgumentError("invalid decimal value", "value", t);
        let i = "-" === t.substring(0, 1);
        i && (t = t.substring(1)),
          "." === t && tQ.throwArgumentError("missing value", "value", t);
        let n = t.split(".");
        n.length > 2 &&
          tQ.throwArgumentError("too many decimal points", "value", t);
        let o = n[0],
          s = n[1];
      ...
      class t0 {
        constructor(t, e, r, i) {
          t !== tJ &&
            ...
            (this._multiplier = tX(i)),
            Object.freeze(this);
        }
        static from(t) {
          if (t instanceof t0) return t;
          ...
          if ("string" == typeof t) {
            if ("fixed" !== t) {
              if ("ufixed" === t) e = !1;
                ...
                n || tQ.throwArgumentError("invalid fixed format", "format", t),
                  (e = "u" !== n[1]),
                  (r = parseInt(n[2])),
                  (i = parseInt(n[3]));
              }
      ...
      class t1 {
        ...
        addUnsafe(t) {
          this._checkFormat(t);
          let e = t$(this._value, this.format.decimals),
            r = t$(t._value, t.format.decimals);
          return t1.fromValue(e.add(r), this.format.decimals, this.format);
        }
        subUnsafe(t) {
          this._checkFormat(t);
          let e = t$(this._value, this.format.decimals),
            r = t$(t._value, t.format.decimals);
          return t1.fromValue(e.sub(r), this.format.decimals, this.format);
        }
        mulUnsafe(t) {
          this._checkFormat(t);
          let e = t$(this._value, this.format.decimals),
        ...
        floor() {
          ...
          1 === t.length && t.push("0");
          let e = t1.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            this.isNegative() && r && (e = e.subUnsafe(t2.toFormat(e.format))),
            e
          );
        }
        ceiling() {
          ...
          let e = t1.from(t[0], this.format),
            r = !t[1].match(/^(0*)$/);
          return (
            !this.isNegative() && r && (e = e.addUnsafe(t2.toFormat(e.format))),
            e
          );
        }
        round(t) {
          ...
          if (
            (1 === e.length && e.push("0"),
            (t < 0 || t > 80 || t % 1) &&
              tQ.throwArgumentError("invalid decimal count", "decimals", t),
            e[1].length <= t)
          )
            return this;
          let r = t1.from("1" + tW.substring(0, t), this.format),
            i = t3.toFormat(this.format);
        ...
        toHexString(t) {
          return null == t
            ? this._hex
            : (t % 8 && tQ.throwArgumentError("invalid byte width", "width", t),
              t_(
                tq
                  .from(this._hex)
        ...
        toFormat(t) {
          return t1.fromString(this._value, t);
        }
        static fromValue(t, e, r) {
          ...
          return (
            ...
            null == e && (e = 0),
            null == r && (r = "fixed"),
            t1.fromString(tZ(t, e), t0.from(r))
          );
        }
        static fromString(t, e) {
          ...
          !r.signed &&
            i.lt(tG) &&
            tV("unsigned value cannot be negative", "overflow", "value", t);
          let n = null;
          return new t1(
            tJ,
            r.signed
              ? i.toTwos(r.width).toHexString()
              : t_(i.toHexString(), r.width / 8),
            tZ(i, r.decimals),
            r
          );
        }
        static fromBytes(t, e) {
          null == e && (e = "fixed");
          let r = t0.from(e);
          if (tS(t).length > r.width / 8) throw Error("overflow");
          let i = tq.from(t);
          return (
        ...
        static from(t, e) {
          if ("string" == typeof t) return t1.fromString(t, e);
          if (tE(t)) return t1.fromBytes(t, e);
          try {
            return t1.fromValue(t, 0, e);
          } catch (t) {
            if (t.code !== tA.errors.INVALID_ARGUMENT) throw t;
          }
          return tQ.throwArgumentError("invalid FixedNumber value", "value", t);
        }
      ...
      let t2 = t1.from(1),
        t3 = t1.from("0.5"),
        t6 = new tA("strings/5.7.0");
      function t8(t, e, r, i, n) {
      ...
      function t4(t, e = d.current) {
        e != d.current && (t6.checkNormalize(), (t = t.normalize(e)));
        let r = [];
        for (let e = 0; e < t.length; e++) {
      ...
      er(en),
        ...
        (function (t) {
          ...
          for (;;) {
            let r = t() - 1;
            if (r < 0) break;
            e.push(ei(1 + t(), 1 + r, t).map((t) => [t[0], t.slice(1)]));
          }
          (function (t) {
            let e = {};
            for (let r = 0; r < t.length; r++) {
      ...
      let eo = `Ethereum Signed Message:
`;
      function es(t) {
        return (
          "string" == typeof t && (t = t4(t)),
          tO(
            (function (t) {
              let e = t.map((t) => tS(t)),
                r = e.reduce((t, e) => t + e.length, 0),
                i = new Uint8Array(r);
              return e.reduce((t, e) => (i.set(e, t), t + e.length), 0), tw(i);
            })([t4(eo), t4(String(t.length)), t])
          )
        );
      }
      new tA("rlp/5.7.0");
      let eu = new tA("address/5.7.0");
      function ef(t) {
        tI(t, 20) || eu.throwArgumentError("invalid address", "address", t);
      ...
      let eh = {};
      for (let t = 0; t < 10; t++) eh[String(t)] = String(t);
      for (let t = 0; t < 26; t++)
        eh[String.fromCharCode(65 + t)] = String(10 + t);
      let ea = Math.floor(
        Math.log10
      ...
      tq.from(
        ...
        t_(ed.toHexString(), 32),
        t_(ec.toHexString(), 32);
      var ep = {},
        em = {};
      function eg(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      eg.equal = function (t, e, r) {
      ...
      (em.inherits = eA),
        ...
        (em.toHex32 = function (t, e) {
          for (var r = "", i = 0; i < t.length; i++) {
            var n = t[i];
            "little" === e && (n = ey(n)), (r += ew(n.toString(16)));
          }
          return r;
        }),
        (em.zero2 = eb),
      ...
      (eM.BlockHash = eE),
        ...
        (eE.prototype.digest = function (t) {
          return (
            this.update(this._pad()), eg(null === this.pending), this._digest(t)
          );
        }),
      ...
      (eI.ft_1 = function (t, e, r, i) {
        ...
        (eI.ch32 = function (t, e, r) {
          return (t & e) ^ (~t & r);
        }),
        (eI.maj32 = eB),
        (eI.p32 = function (t, e, r) {
          return t ^ e ^ r;
        }),
        (eI.s0_256 = function (t) {
          return eN(t, 2) ^ eN(t, 13) ^ eN(t, 22);
        }),
        (eI.s1_256 = function (t) {
          return eN(t, 6) ^ eN(t, 11) ^ eN(t, 25);
        }),
        (eI.g0_256 = function (t) {
          return eN(t, 7) ^ eN(t, 18) ^ (t >>> 3);
        }),
        (eI.g1_256 = function (t) {
          return eN(t, 17) ^ eN(t, 19) ^ (t >>> 10);
        });
      var eC = em.rotl32,
        e_ = em.sum32,
        ex = em.sum32_5,
        eO = eI.ft_1,
        eR = eM.BlockHash,
        ek = [1518500249, 1859775393, 2400959708, 3395469782];
      function eP() {
      ...
      em.inherits(eP, eR),
        ...
        (eP.prototype._update = function (t, e) {
          ...
          for (; i < r.length; i++)
            r[i] = eC(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
          ...
          for (i = 0; i < r.length; i++) {
            var h = ~~(i / 20),
              a = ex(eC(n, 5), eO(h, o, s, u), f, r[i], ek[h]);
            (f = u), (u = s), (s = eC(o, 30)), (o = n), (n = a);
          }
          (this.h[0] = e_(this.h[0], n)),
            (this.h[1] = e_(this.h[1], o)),
            (this.h[2] = e_(this.h[2], s)),
            (this.h[3] = e_(this.h[3], u)),
            (this.h[4] = e_(this.h[4], f));
        }),
      ...
      function eJ() {
        if (!(this instanceof eJ)) return new eJ();
        eK.call(this),
          (this.h = [
      ...
      em.inherits(eJ, eK),
        ...
        (eJ.hmacStrength = 192),
        (eJ.padLength = 64),
        (eJ.prototype._update = function (t, e) {
          for (var r = this.W, i = 0; i < 16; i++) r[i] = t[e + i];
          for (; i < r.length; i++)
            r[i] = eT(eH(r[i - 2]), r[i - 7], ej(r[i - 15]), r[i - 16]);
          var n = this.h[0],
            o = this.h[1],
            s = this.h[2],
            u = this.h[3],
            ...
            a = this.h[6],
            l = this.h[7];
          for (eg(this.k.length === r.length), i = 0; i < r.length; i++) {
            var c = eD(l, ez(f), eF(f, h, a), this.k[i], r[i]),
              d = eU(eq(n), eL(n, o, s));
            (l = a),
              (a = h),
              (h = f),
          ...
          (this.h[0] = eU(this.h[0], n)),
            (this.h[1] = eU(this.h[1], o)),
            (this.h[2] = eU(this.h[2], s)),
            (this.h[3] = eU(this.h[3], u)),
            (this.h[4] = eU(this.h[4], f)),
            (this.h[5] = eU(this.h[5], h)),
            (this.h[6] = eU(this.h[6], a)),
            (this.h[7] = eU(this.h[7], l));
        }),
        (eJ.prototype._digest = function (t) {
          return "hex" === t
            ? em.toHex32(this.h, "big")
            : em.split32(this.h, "big");
        }),
      ...
      em.inherits(e5, e8),
        ...
        (e5.hmacStrength = 192),
        (e5.padLength = 128),
        (e5.prototype._prepareBlock = function (t, e) {
          ...
          for (; i < r.length; i += 2) {
            var n = (function (t, e) {
              ...
              o = (function (t, e) {
                var r = eV(t, e, 19) ^ eV(e, t, 29) ^ eX(t, e, 6);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 4], r[i - 3]),
              s = r[i - 14],
              u = r[i - 13],
              ...
              h = (function (t, e) {
                var r = eV(t, e, 1) ^ eV(t, e, 8) ^ eX(t, e, 7);
                return r < 0 && (r += 4294967296), r;
              })(r[i - 30], r[i - 29]),
              a = r[i - 32],
              l = r[i - 31];
            (r[i] = e1(n, o, s, u, f, h, a, l)),
              (r[i + 1] = e2(n, o, s, u, f, h, a, l));
          }
        }),
        (e5.prototype._update = function (t, e) {
          ...
          for (var y = 0; y < r.length; y += 2) {
            var b = v,
              ...
              E = (function (t, e) {
                var r = eV(t, e, 14) ^ eV(t, e, 18) ^ eV(e, t, 9);
                return r < 0 && (r += 4294967296), r;
              })(l, c),
              ...
              C = r[y],
              _ = r[y + 1],
              x = e3(b, w, M, E, S, I, N, B, C, _),
              O = e6(b, w, M, E, S, I, N, B, C, _);
            b = (function (t, e) {
            ...
            var R = e$(
                b,
                (w = (function (t, e) {
                  var r = eV(t, e, 28) ^ eV(e, t, 2) ^ eV(e, t, 7);
                  return r < 0 && (r += 4294967296), r;
                })(i, n)),
      ...
      em.inherits(ro, rn),
        ...
        (ro.hmacStrength = 192),
        (ro.padLength = 64),
        (ro.prototype._update = function (t, e) {
          for (
            var r = this.h[0],
              i = this.h[1],
              n = this.h[2],
          ...
          (m = rr(this.h[1], n, a)),
            (this.h[1] = rr(this.h[2], o, l)),
            (this.h[2] = rr(this.h[3], s, u)),
            (this.h[3] = rr(this.h[4], r, f)),
            (this.h[4] = rr(this.h[0], i, h)),
            (this.h[0] = m);
        }),
      ...
      function rl(t, e, r) {
        if (!(this instanceof rl)) return new rl(t, e, r);
        (this.Hash = t),
      ...
      (rl.prototype._init = function (t) {
        t.length > this.blockSize && (t = new this.Hash().update(t).digest()),
          eg(t.length <= this.blockSize);
        ...
        (rl.prototype.update = function (t, e) {
          return this.inner.update(t, e), this;
        }),
        (rl.prototype.digest = function (t) {
        ...
        (ep.hmac = rl),
        (ep.sha1 = ep.sha.sha1),
        (ep.sha256 = ep.sha.sha256),
        (ep.sha224 = ep.sha.sha224),
        (ep.sha384 = ep.sha.sha384),
        (ep.sha512 = ep.sha.sha512),
        (ep.ripemd160 = ep.ripemd.ripemd160);
      var rd = rp;
      function rp(t, e) {
        if (!t) throw Error(e || "Assertion failed");
      }
      rp.equal = function (t, e, r) {
        if (t != e) throw Error(r || "Assertion failed: " + t + " != " + e);
      };
      var rm = rc(function (t, e) {
          function r(t) {
            return 1 === t.length ? "0" + t : t;
          }
          function i(t) {
      ...
      function rb(t, e) {
        (this.type = t),
          (this.p = new tP(e.p, 16)),
          (this.red = e.prime ? tP.red(e.prime) : tP.mont(this.p)),
          (this.zero = new tP(0).toRed(this.red)),
          (this.one = new tP(1).toRed(this.red)),
          (this.two = new tP(2).toRed(this.red)),
          (this.n = e.n && new tP(e.n, 16)),
      ...
      (rb.prototype.point = function () {
        ...
        (rb.prototype._wnafMulAdd = function (t, e, r, i, n) {
          ...
          for (o = i - 1; o >= 1; o -= 2) {
            var d = o - 1,
              p = o;
            if (1 !== f[d] || 1 !== f[p]) {
              (a[d] = rv(r[d], f[d], this._bitLength)),
                (a[p] = rv(r[p], f[p], this._bitLength)),
        ...
        (rb.BasePoint = rw),
        (rw.prototype.eq = function () {
          throw Error("Not implemented");
        }),
        (rw.prototype.validate = function () {
        ...
        (rw.prototype.encodeCompressed = function (t) {
          return this.encode(t, !0);
        }),
        (rw.prototype._encode = function (t) {
        ...
        (rw.prototype.encode = function (t, e) {
          return rg.encode(this._encode(e), t);
        }),
        (rw.prototype.precompute = function (t) {
        ...
        (rw.prototype._hasDoubles = function (t) {
        ...
        (rw.prototype._getDoubles = function (t, e) {
        ...
        (rw.prototype._getNAFPoints = function (t) {
        ...
        (rw.prototype._getBeta = function () {
          return null;
        }),
        (rw.prototype.dblp = function (t) {
          for (var e = this, r = 0; r < t; r++) e = e.dbl();
          return e;
        });
      var rM = rc(function (t) {
          "function" == typeof Object.create
      ...
      function rS(t) {
        rb.call(this, "short", t),
          (this.a = new tP(t.a, 16).toRed(this.red)),
          (this.b = new tP(t.b, 16).toRed(this.red)),
      ...
      rM(rS, rb),
        (rS.prototype._getEndomorphism = function (t) {
          if (!(!this.zeroA || !this.g || !this.n || 1 !== this.p.modn(3))) {
            if (t.beta) e = new tP(t.beta, 16).toRed(this.red);
            else {
              var e,
                r,
                i,
            ...
            if (t.lambda) r = new tP(t.lambda, 16);
            else {
              var o = this._getEndoRoots(this.n);
              0 === this.g.mul(o[0]).x.cmp(this.g.x.redMul(e))
                ? (r = o[0])
                : ((r = o[1]),
                  rE(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
            }
            return (
              (i = t.basis
                ? t.basis.map(function (t) {
                    return { a: new tP(t.a, 16), b: new tP(t.b, 16) };
                  })
        ...
        (rS.prototype._getEndoRoots = function (t) {
          var e = t === this.p ? this.red : tP.mont(t),
            r = new tP(2).toRed(e).redInvm(),
            i = r.redNeg(),
            n = new tP(3).toRed(e).redNeg().redSqrt().redMul(r);
        ...
        (rS.prototype.pointFromX = function (t, e) {
          (t = new tP(t, 16)).red || (t = t.toRed(this.red));
          var r = t
              .redSqr()
              .redMul(t)
        ...
        (rS.prototype.pointFromJSON = function (t, e) {
          return rI.fromJSON(this, t, e);
        }),
        (rI.prototype._getBeta = function () {
          if (this.curve.endo) {
        ...
        (rI.prototype.isInfinity = function () {
          return this.inf;
        }),
        ...
        (rI.prototype.getX = function () {
          return this.x.fromRed();
        }),
        (rI.prototype.getY = function () {
          return this.y.fromRed();
        }),
        (rI.prototype.mul = function (t) {
          return (
            (t = new tP(t, 16)),
            this.isInfinity()
              ? this
        ...
        (rI.prototype.mulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
        ...
        (rI.prototype.jmulAdd = function (t, e, r) {
          var i = [this, e],
            n = [t, r];
          return this.curve.endo
        ...
        (rN.prototype.mixedAdd = function (t) {
        ...
        (rN.prototype.mul = function (t, e) {
          return (t = new tP(t, e)), this.curve._wnafMul(this, t);
        }),
        ...
        (rN.prototype.eqXToP = function (t) {
          var e = this.z.redSqr(),
      ...
      var rB = rc(function (t, e) {
          (e.base = rb), (e.short = rS), (e.mont = null), (e.edwards = null);
        }),
        rC = rc(function (t, e) {
          var r,
            i = rg.assert;
      ...
      function r_(t) {
        if (!(this instanceof r_)) return new r_(t);
        (this.hash = t.hash),
      ...
      (r_.prototype._init = function (t, e, r) {
        ...
        (r_.prototype._hmac = function () {
          return new ep.hmac(this.hash, this.K);
        }),
        (r_.prototype._update = function (t) {
        ...
        (r_.prototype.reseed = function (t, e, r, i) {
        ...
        (r_.prototype.generate = function (t, e, r, i) {
      ...
      (rO.fromPublic = function (t, e, r) {
        return e instanceof rO ? e : new rO(t, { pub: e, pubEnc: r });
      }),
        (rO.fromPrivate = function (t, e, r) {
          return e instanceof rO ? e : new rO(t, { priv: e, privEnc: r });
        }),
        (rO.prototype.validate = function () {
        ...
        (rO.prototype.getPublic = function (t, e) {
          return (
        ...
        (rO.prototype.getPrivate = function (t) {
          return "hex" === t ? this.priv.toString(16, 2) : this.priv;
        }),
        (rO.prototype._importPrivate = function (t, e) {
          (this.priv = new tP(t, e || 16)),
            (this.priv = this.priv.umod(this.ec.curve.n));
        }),
        (rO.prototype._importPublic = function (t, e) {
          if (t.x || t.y) {
        ...
        (rO.prototype.derive = function (t) {
          return (
            t.validate() || rx(t.validate(), "public point not validated"),
            t.mul(this.priv).getX()
          );
        }),
        (rO.prototype.sign = function (t, e, r) {
          return this.ec.sign(t, this, e, r);
        }),
        (rO.prototype.verify = function (t, e) {
      ...
      function rk(t, e) {
        ...
        this._importDER(t, e) ||
          ...
          (this.r = new tP(t.r, 16)),
          (this.s = new tP(t.s, 16)),
      ...
      (rk.prototype._importDER = function (t, e) {
        t = rg.toArray(t, e);
        var r = new rP();
        ...
        (rk.prototype.toDER = function (t) {
          ...
          for (
            ...
            r = r.slice(1);
          var i = [2];
          rD(i, e.length), (i = i.concat(e)).push(2), rD(i, r.length);
          var n = i.concat(r),
            o = [48];
          return rD(o, n.length), (o = o.concat(n)), rg.encode(o, t);
        });
      var rF = function () {
      ...
      function rq(t) {
        ...
        "string" == typeof t &&
          (rL(
            Object.prototype.hasOwnProperty.call(rC, t),
            "Unknown curve " + t
          ),
          (t = rC[t])),
          t instanceof rC.PresetCurve && (t = { curve: t }),
      ...
      (rq.prototype.keyPair = function (t) {
        ...
        (rq.prototype.keyFromPrivate = function (t, e) {
          return rO.fromPrivate(this, t, e);
        }),
        (rq.prototype.keyFromPublic = function (t, e) {
          return rO.fromPublic(this, t, e);
        }),
        (rq.prototype.genKeyPair = function (t) {
          ...
          for (
            var e = new r_({
                ...
                entropy: t.entropy || rF(this.hash.hmacStrength),
                entropyEnc: (t.entropy && t.entropyEnc) || "utf8",
                nonce: this.n.toArray(),
              }),
              r = this.n.byteLength(),
              i = this.n.sub(new tP(2));
            ;

          ) {
            var n = new tP(e.generate(r));
        ...
        (rq.prototype.sign = function (t, e, r, i) {
          "object" == typeof r && ((i = r), (r = null)),
            ...
            (t = this._truncateToN(new tP(t, 16)));
          for (
            var n = this.n.byteLength(),
              ...
              f = this.n.sub(new tP(1)),
              h = 0;
            ;
            h++
          ) {
            var a = i.k ? i.k(h) : new tP(u.generate(this.n.byteLength()));
            if (
                  ...
                  if (0 !== (p = p.umod(this.n)).cmpn(0)) {
                    ...
                    return (
                      i.canonical &&
                        p.cmp(this.nh) > 0 &&
                        ((p = this.n.sub(p)), (m ^= 1)),
                      new rk({ r: d, s: p, recoveryParam: m })
                    );
                  }
                }
              }
        ...
        (rq.prototype.recoverPubKey = function (t, e, r, i) {
          rL((3 & r) === r, "The recovery param is more than two bits"),
            (e = new rk(e, i));
          var n = this.n,
            o = new tP(t),
            s = e.r,
        ...
        (rq.prototype.getKeyRecoveryParam = function (t, e, r, i) {
          if (null !== (e = new rk(e, i)).recoveryParam) return e.recoveryParam;
          for (var n, o = 0; o < 4; o++) {
            try {
      ...
      let rj = new tA("signing-key/5.7.0"),
        rH = null;
      function rK() {
        return rH || (rH = new rz("secp256k1")), rH;
      }
      class rQ {
        constructor(t) {
          el(this, "curve", "secp256k1"),
            el(this, "privateKey", tB(t)),
            32 !==
              (function (t) {
                if ("string" != typeof t) t = tB(t);
                else if (!tI(t) || t.length % 2) return null;
                return (t.length - 2) / 2;
              })(this.privateKey) &&
          ...
          let e = rK().keyFromPrivate(tS(this.privateKey));
          el(this, "publicKey", "0x" + e.getPublic(!1, "hex")),
            el(this, "compressedPublicKey", "0x" + e.getPublic(!0, "hex")),
            el(this, "_isSigningKey", !0);
        }
        _addPoint(t) {
          let e = rK().keyFromPublic(tS(this.publicKey)),
            r = rK().keyFromPublic(tS(t));
        ...
        signDigest(t) {
          let e = rK().keyFromPrivate(tS(this.privateKey)),
            r = tS(t);
          32 !== r.length &&
            rj.throwArgumentError("bad digest length", "digest", t);
          let i = e.sign(r, { canonical: !0 });
          return tx({
            recoveryParam: i.recoveryParam,
            r: t_("0x" + i.r.toString(16), 32),
            s: t_("0x" + i.s.toString(16), 32),
          });
        }
        computeSharedSecret(t) {
          let e = rK().keyFromPrivate(tS(this.privateKey)),
            r = rK().keyFromPublic(tS(rJ(t)));
          return t_("0x" + e.derive(r.getPublic()).toString(16), 32);
        }
      ...
      function rJ(t, e) {
        ...
        if (32 === r.length) {
          let t = new rQ(r);
          return e
            ? "0x" + rK().keyFromPrivate(r).getPublic(!0, "hex")
            : t.publicKey;
        }
        return 33 === r.length
          ? e
            ? tB(r)
            : "0x" + rK().keyFromPublic(r).getPublic(!1, "hex")
          : 65 === r.length
          ? e
            ? "0x" + rK().keyFromPublic(r).getPublic(!0, "hex")
            : tB(r)
          : rj.throwArgumentError(
          ...
          case "eip191":
            ...
            return (
              ...
              (function (t) {
                ...
                if (
                  ("string" != typeof t &&
                    eu.throwArgumentError("invalid address", "address", t),
                  ...
                  for (
                    t.substring(2, 4) !==
                      ...
                      eu.throwArgumentError("bad icap checksum", "address", t),
                      e = new tT(t.substring(4), 36).toString(16);
                    e.length < 40;

                  )
                    e = "0" + e;
                  e = ef("0x" + e);
                } else eu.throwArgumentError("invalid address", "address", t);
                return e;
              })(
                tC(
                  tO(
                      ...
                      rJ(
                        (function (t, e) {
                          ...
                          return (
                            "0x" +
                            rK()
                              .recoverPubKey(tS(t), i, r.recoveryParam)
                              .encode("hex", !1)
                          );
                        })(tS(es(e)), s)
                      ),
      ...
      var rV = Object.defineProperty,
        ...
        r1 = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        r2 = (t, e) => {
          for (var r in e || (e = {})) r$.call(e, r) && r1(t, r, e[r]);
          if (rZ) for (var r of rZ(e)) r0.call(e, r) && r1(t, r, e[r]);
          return t;
        },
        r3 = (t, e) => rW(t, rX(e));
      let r6 = (t) => t?.split(":"),
      ...
      async function r7(t) {
        let { cacao: e, projectId: r } = t,
          ...
          o = r9(n, n.iss),
          s = r5(n.iss);
        return await rG(s, o, i, r8(n.iss), r);
      }
      let r9 = (t, e) => {
...
- ${t}`
        ...
        return (
          ...
          [r, i, "", n, "", o, s, u, f, h, a].filter((t) => null != t).join(`
`)
        );
      };
      function it(t) {
      ...
      function ie(t) {
        return (
          it(t),
          `urn:recap:${_.from(JSON.stringify(t))
            .toString("base64")
            .replace(/=/g, "")}`
        );
      }
      function ir(t) {
        ...
        let r =
          ...
          JSON.parse(_.from(e, "base64").toString("utf-8")));
        return it(r), r;
      }
      function ii(t, e, r) {
        return ie(
      ...
      function im() {
        let t = I.Au();
        return {
          privateKey: (0, N.BB)(t.secretKey, il),
          publicKey: (0, N.BB)(t.publicKey, il),
        };
      }
      function ig() {
      ...
      function iv(t, e) {
        let r = I.gi((0, N.mL)(t, il), (0, N.mL)(e, il), !0),
          i = new M.t(S.mE, r).expand(32);
        return (0, N.BB)(i, il);
      }
      function iA(t) {
        let e = (0, S.vp)((0, N.mL)(t, il));
        return (0, N.BB)(e, il);
      }
      function iy(t) {
        let e = (0, S.vp)((0, N.mL)(t, id));
        return (0, N.BB)(e, il);
      }
      function ib(t) {
        return Number((0, N.BB)(t, ia));
      }
      function iw(t) {
        var e;
        let r = ((e = "u" > typeof t.type ? t.type : 0), (0, N.mL)(`${e}`, ia));
        if (ib(r) === ip && typeof t.senderPublicKey > "u")
          throw Error("Missing sender public key for type 1 envelope");
        let i =
            "u" > typeof t.senderPublicKey
              ? (0, N.mL)(t.senderPublicKey, il)
              : void 0,
          n = "u" > typeof t.iv ? (0, N.mL)(t.iv, il) : (0, E.randomBytes)(12);
        return (function (t) {
          if (ib(t.type) === ip) {
          ...
          return (0, N.BB)((0, N.zo)([t.type, t.iv, t.sealed]), ic);
        })({
          type: r,
          sealed: new w.OK((0, N.mL)(t.symKey, il)).seal(
            n,
            (0, N.mL)(t.message, id)
          ),
          iv: n,
      ...
      function iM(t) {
        let e = new w.OK((0, N.mL)(t.symKey, il)),
          { sealed: r, iv: i } = iE(t.encoded),
          n = e.open(i, r);
      ...
      var i_ = Object.defineProperty,
        ...
        iU = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        iT = (t, e) => {
          for (var r in e || (e = {})) ik.call(e, r) && iU(t, r, e[r]);
          if (iR) for (var r of iR(e)) iP.call(e, r) && iU(t, r, e[r]);
          return t;
        },
        iD = (t, e) => ix(t, iO(e));
      function iF(t) {
      ...
      function iH(t, e) {
        ...
        for (let [e, i] of Object.entries(r))
          i.methods ? (i.methods = to(i.methods, t)) : (i.methods = t),
      ...
      function iX(t, e) {
        return !!(e && iW(t)) || ("string" == typeof t && !!t.trim().length);
      }
      function iZ(t, e) {
        return !!(e && iW(t)) || ("number" == typeof t && !isNaN(t));
      }
      function i$(t, e) {
        ...
        return (
          ...
          (i.forEach((e) => {
            let { accounts: i, methods: n, events: s } = t.namespaces[e],
              u = iq(i),
              f = r[e];
            (G(R(e, f), u) && G(f.methods, n) && G(f.events, s)) || (o = !1);
          }),
          o)
        );
      }
      function i0(t) {
        return !!(iX(t, !1) && t.includes(":")) && 2 === t.split(":").length;
      }
      function i1(t) {
        if (iX(t, !1))
          try {
      ...
      function i8(t) {
        let e = !0;
        return (
          iY(t) ? t.length && (e = t.every((t) => iX(t, !1))) : (e = !1), e
        );
      }
      function i4(t, e) {
        let r = null;
      ...
      function nn(t) {
        return !(iW(t) || !iX(t.method, !1));
      }
      function no(t) {
        return !(
          iW(t) ||
          (iW(t.result) && iW(t.error)) ||
          !iZ(t.id, !1) ||
          !iX(t.jsonrpc, !1)
        );
      }
      function ns(t) {
        return !(iW(t) || !iX(t.name, !1));
      }
      function nu(t, e) {
        return !(
          !i0(e) ||
      ...
      Approved: ${u.toString()}`
        ...
        Approved: ${n.toString()}`
          ...
          s.forEach((t) => {
            i ||
              (G(n[t].methods, o[t].methods)
                ? G(n[t].events, o[t].events) ||
                  (i = iJ(
                    "NON_CONFORMING_NAMESPACES",
